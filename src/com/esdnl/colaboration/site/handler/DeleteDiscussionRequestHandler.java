...
public class DeleteDiscussionRequestHandler extends RequestHandlerImpl {

	public DeleteDiscussionRequestHandler() {
	...
	public String handleRequest(HttpServletRequest request, HttpServletResponse response)
		...
		if (validate_form()) {
			...
			try {
				...
				CollaborationManager.deleteDiscussionBeans(form.getInt("id"));
