...
public class UpdateDropdownItemRequestHandler  extends RequestHandlerImpl{
	public UpdateDropdownItemRequestHandler() {
	...
	throws ServletException,
		...
		try {
				...
				ebean.setId(form.getInt("itemid"));
				ebean.setDdId(form.getInt("ddid"));
				DropdownManager.updateDropdownItem(ebean);
