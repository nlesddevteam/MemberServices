...
import com.esdnl.payadvice.dao.NLESDPayAdviceAftTaxesDedManager;
import com.esdnl.payadvice.dao.NLESDPayAdviceAftTaxesDedTotalsManager;
import com.esdnl.payadvice.dao.NLESDPayAdviceBefTaxesDedManager;
import com.esdnl.payadvice.dao.NLESDPayAdviceBefTaxesDedTotalsManager;
import com.esdnl.payadvice.dao.NLESDPayAdviceEarningsManager;
import com.esdnl.payadvice.dao.NLESDPayAdviceEarningsTotalsManager;
import com.esdnl.payadvice.dao.NLESDPayAdviceEmpPaidBenefitsManager;
import com.esdnl.payadvice.dao.NLESDPayAdviceEmpPaidBenefitsTotalsManager;
import com.esdnl.payadvice.dao.NLESDPayAdviceEmployeeInfoManager;
import com.esdnl.payadvice.dao.NLESDPayAdviceInformationManager;
import com.esdnl.payadvice.dao.NLESDPayAdviceMessageManager;
import com.esdnl.payadvice.dao.NLESDPayAdvicePayGroupManager;
import com.esdnl.payadvice.dao.NLESDPayAdviceTaxesManager;
import com.esdnl.payadvice.dao.NLESDPayAdviceTaxesTotalsManager;
...
public class ViewNLESDPayAdviceTestStubRequestHandler extends RequestHandlerImpl {
ServletOutputStream sOut;
    public ViewNLESDPayAdviceTestStubRequestHandler() {
	...
	public String handleRequest(HttpServletRequest request, HttpServletResponse reponse)
		...
		try {
		        ...
		        //we check to see if they have more than one pay stub for period
		        ...
		        for(Map.Entry<Integer,String> entry : pslist.entrySet()) {
					//now we get the empinfoid in case two paystubs
			      ...
			      //now we print the Earnings
			       ...
			       NLESDPayAdviceEarningsTotalsBean erntot = NLESDPayAdviceEarningsTotalsManager.getNLESDPayAdviceEarningsTotalsBean(
			        ...
			        if(mbean != null)
			        {
			        	...
			        	objPage.getElements().add(new Label("", 335, 365, 235,36, Font.getHelvetica(), 10, TextAlign.LEFT));
			        }
		        ...
		        document.drawToWeb(request, reponse, sOut, "paystub.pdf");
