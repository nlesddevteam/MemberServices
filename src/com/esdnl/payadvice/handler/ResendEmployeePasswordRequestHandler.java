...
public class ResendEmployeePasswordRequestHandler extends RequestHandlerImpl{
	public ResendEmployeePasswordRequestHandler() {
	...
	throws ServletException,
		...
		System.out.println(form.get("pid"));
		String payrollid = StringUtils.leftPad(form.get("pid"),9,"0");
		try {
