...
public class ChangeRequestTypeRequestHandler implements RequestHandler
{
    ...
    throws ServletException, IOException
  {
    ...
    else if((request.getParameter("req_type") == null) || (request.getParameter("req_type").equals("")))
    {
      request.setAttribute("msg", "NEW REQUEST TYPE is require.");
    }
    else
    {
      MaintenanceRequestDB.changeRequestType(Integer.parseInt(request.getParameter("req")), request.getParameter("req_type"));
    }
