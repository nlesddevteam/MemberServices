...
public class ViewRequestTypeReportRequestHandler  implements RequestHandler
{
    ...
    throws ServletException, IOException
  {
    ...
    //else
      session.setAttribute("OUTSTANDING_REQUESTS", MaintenanceRequestDB.getOutstandingMaintenanceRequestsPagesByRequestType(usr.getPersonnel(), request.getParameter("type_id"), 10));
