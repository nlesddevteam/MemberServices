...
public class ViewAllOutstandingRequestsRequestHandler  implements RequestHandler
{
    ...
    throws ServletException, IOException
  {
    ...
    if((usr.getUserPermissions().containsKey("MAINTENANCE-ADMIN-REGIONAL-VIEW")))
      ...
      session.setAttribute("OUTSTANDING_REQUESTS", MaintenanceRequestDB.getOutstandingMaintenanceRequestsPages(10));
