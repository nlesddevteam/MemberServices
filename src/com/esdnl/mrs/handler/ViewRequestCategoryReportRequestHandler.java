...
public class ViewRequestCategoryReportRequestHandler  implements RequestHandler
{
    ...
    throws ServletException, IOException
  {
    ...
    //System.out.println(request.getParameter("cat_id"));
    ...
    //else
      session.setAttribute("OUTSTANDING_REQUESTS", MaintenanceRequestDB.getOutstandingMaintenanceRequestsPagesByRequestCategory(usr.getPersonnel(), request.getParameter("cat_id"), 10));
