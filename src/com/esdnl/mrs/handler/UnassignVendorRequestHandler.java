...
public class UnassignVendorRequestHandler  implements RequestHandler
{
    ...
    throws ServletException, IOException
  {
    ...
    else if((request.getParameter("vid") == null) || (request.getParameter("vid").equals("")))
    {
      request.setAttribute("msg", "VENDOR ID is require.");
    }
    else
    {
      MaintenanceRequestDB.unassignVendor(Integer.parseInt(request.getParameter("req")), Integer.parseInt(request.getParameter("vid")));
    }
