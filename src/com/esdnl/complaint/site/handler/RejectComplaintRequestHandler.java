...
public class RejectComplaintRequestHandler implements RequestHandler
{
    ...
    try
    {
      ...
      else
      {
        ...
        else
        {
          ...
          {
            ComplaintManager.rejectComplaintBean(complaint, usr.getPersonnel());
      ...
      path = "admin_reject_complaint.jsp";
    }
