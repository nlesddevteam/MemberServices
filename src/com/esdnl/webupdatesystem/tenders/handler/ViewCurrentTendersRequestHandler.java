...
public class ViewCurrentTendersRequestHandler extends RequestHandlerImpl {
	public ViewCurrentTendersRequestHandler() {
	...
	public String handleRequest(HttpServletRequest request, HttpServletResponse reponse)
	    ...
	    try {
			...
			request.setAttribute("tenders", TendersManager.getTendersByStatus(1));
			
		} catch (TenderException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	    path = "viewCurrentTenders.jsp";
	    return path;
	}
}
