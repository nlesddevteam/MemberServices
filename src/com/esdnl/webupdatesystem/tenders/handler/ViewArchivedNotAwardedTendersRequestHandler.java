...
public class ViewArchivedNotAwardedTendersRequestHandler extends RequestHandlerImpl {
	public ViewArchivedNotAwardedTendersRequestHandler() {
	...
	public String handleRequest(HttpServletRequest request, HttpServletResponse reponse)
	    ...
	    path = "viewArchivedNotAwardedTenders.jsp";
	    return path;
	}
}
