...
public class ViewArchivedAwardedTendersRequestHandler extends RequestHandlerImpl {
	public ViewArchivedAwardedTendersRequestHandler() {
	...
	public String handleRequest(HttpServletRequest request, HttpServletResponse reponse)
	    ...
	    path = "viewArchivedAwardedTenders.jsp";
	    return path;
	}
}
