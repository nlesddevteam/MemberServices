...
public class ViewCancelledTendersRequestHandler extends RequestHandlerImpl {
	public ViewCancelledTendersRequestHandler() {
	...
	public String handleRequest(HttpServletRequest request, HttpServletResponse reponse)
	    ...
	    try {
			...
			request.setAttribute("tenders", TendersManager.getTendersByStatus(3));
			
		} catch (TenderException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	    path = "viewCancelledTenders.jsp";
	    return path;
	}
}
