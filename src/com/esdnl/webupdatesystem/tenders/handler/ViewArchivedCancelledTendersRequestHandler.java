...
public class ViewArchivedCancelledTendersRequestHandler extends RequestHandlerImpl {
	public ViewArchivedCancelledTendersRequestHandler() {
	...
	public String handleRequest(HttpServletRequest request, HttpServletResponse reponse)
	    ...
	    path = "viewArchivedCancelledTenders.jsp";
	    return path;
	}
}
