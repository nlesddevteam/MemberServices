...
public class ViewArchivedClosedTendersRequestHandler extends RequestHandlerImpl {
	public ViewArchivedClosedTendersRequestHandler() {
	...
	public String handleRequest(HttpServletRequest request, HttpServletResponse reponse)
	    ...
	    path = "viewArchivedClosedTenders.jsp";
	    return path;
	}
}
