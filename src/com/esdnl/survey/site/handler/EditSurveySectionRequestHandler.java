...
public class EditSurveySectionRequestHandler extends RequestHandlerImpl {

	public EditSurveySectionRequestHandler() {
	...
	public String handleRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			if (validate_form()) {
				...
				if (section != null) {
					request.setAttribute("survey", SurveyManager.getSuveryBean(section.getSurveyId()));
