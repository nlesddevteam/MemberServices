...
public class ContactRelationshipTagHandler extends TagSupport {
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			for (KindergartenRegistrantBean.REGISTRANT_RELATIONSHIP s : KindergartenRegistrantBean.REGISTRANT_RELATIONSHIP.values()) {
				if (s.getValue() > 0)
