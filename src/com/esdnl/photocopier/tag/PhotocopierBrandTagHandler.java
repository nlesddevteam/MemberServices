...
public class PhotocopierBrandTagHandler  extends TagSupport
{
  private String id;
  private String cls;
  ...
  {
    JspWriter out = null;
    BrandBean[] beans = null;
    
    try
    {
      beans = BrandManager.getBrandBeans();
      ...
      out.println("<OPTION VALUE='-1'>SELECT BRAND</OPTION>");
