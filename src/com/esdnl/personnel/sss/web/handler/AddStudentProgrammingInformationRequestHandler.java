...
public class AddStudentProgrammingInformationRequestHandler extends RequestHandlerImpl {

	public AddStudentProgrammingInformationRequestHandler() {
	...
	public String handleRequest(HttpServletRequest request, HttpServletResponse response)
		...
		if (validate_form()) {
			...
			try {
				...
				info.setSchoolYear(profile.getProjectedSchoolYear());
				...
				StudentProgrammingInfoManager.addStudentProgrammingInfoBean(info);
