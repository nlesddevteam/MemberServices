...
public class UpdateStudentProgrammingInformationRequestHandler extends RequestHandlerImpl {

	public UpdateStudentProgrammingInformationRequestHandler() {
		...
		if (validate_form()) {
			...
			try {
				...
				StudentProgrammingInfoBean info = StudentProgrammingInfoManager.getStudentProgrammingInfoBean(
						form.get("student_id"), profile.getCurrentSchoolYear());
				...
				if (info.isDirty())
					StudentProgrammingInfoManager.updateCurrentlyApprovedStudentProgrammingInfoBean(info);
