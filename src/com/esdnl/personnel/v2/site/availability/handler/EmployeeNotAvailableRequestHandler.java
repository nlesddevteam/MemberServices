...
public class EmployeeNotAvailableRequestHandler implements RequestHandler
{
    ...
    throws ServletException, IOException
  {
    ...
    try
    {
      ...
      if(!StringUtils.isEmpty(op))
      {
        ...
        int reasonCode = Integer.parseInt(request.getParameter("reason_code"));
        ...
        bean.setNotAvailableBy(usr.getPersonnel().getPersonnelID());
        ...
        while(!s_cal.after(e_cal))
        {
          ...
          catch(EmployeeException e)
          {
            ...
            if(msg == null)
              ...
              msg += sdf2.format(bean.getStartDate()) + " - " + sdf2.format(bean.getEndDate());
      ...
      path = "employee_not_available.jsp";
    }
    catch(Exception e)
    {
      e.printStackTrace();
