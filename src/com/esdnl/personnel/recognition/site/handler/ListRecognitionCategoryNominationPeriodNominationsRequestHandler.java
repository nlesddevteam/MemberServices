...
public class ListRecognitionCategoryNominationPeriodNominationsRequestHandler  extends RequestHandlerImpl{
	
	public ListRecognitionCategoryNominationPeriodNominationsRequestHandler()
  {
  ...
  { 
    ...
    if(validate_form())
    {
      try
      {
      	NominationPeriodBean period = NominationPeriodManager.getNominationPeriodBean(form.getInt("id"));
      ...
      catch(RecognitionException e)
      {
        ...
        request.setAttribute("msg", "Could retrieve NOMINATION records.");
      }
    }
    else
    {
