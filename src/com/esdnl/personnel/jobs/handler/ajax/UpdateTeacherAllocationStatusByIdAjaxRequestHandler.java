...
public class UpdateTeacherAllocationStatusByIdAjaxRequestHandler extends RequestHandlerImpl {

	public UpdateTeacherAllocationStatusByIdAjaxRequestHandler() {

		this.validator = new FormValidator(new FormElement[] {
				new RequiredFormElement("allocationid", "Allocation ID is required."),
	...
	public String handleRequest(HttpServletRequest request, HttpServletResponse response)
		...
		if (validate_form()) {
			try {
				TeacherAllocationManager.updateTeacherAllocationBeanStatus(form.getInt("allocationid"),
						form.getBoolean("enabled"));
