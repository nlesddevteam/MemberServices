...
public class UnsetJobInterviewGuideRequestHandler extends RequestHandlerImpl {

	public UnsetJobInterviewGuideRequestHandler() {
	...
	public String handleRequest(HttpServletRequest request, HttpServletResponse response)
		...
		if (validate_form()) {
			try {
				...
				if (job != null) {
					InterviewGuideManager.unsetJobInterviewGuideBean(job);
