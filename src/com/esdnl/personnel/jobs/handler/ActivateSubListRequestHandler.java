...
public class ActivateSubListRequestHandler extends RequestHandlerImpl {

	public ActivateSubListRequestHandler() {
	...
	public String handleRequest(HttpServletRequest request,
		...
		try {
			...
			if (validate_form()) {
				...
				audbean.setEntryType(SublistAuditTypeCostant.LISTACTIVATED);
				audbean.setEntryBy(usr.getPersonnel());
				audbean.setEntryNotes("List Activated By: " + usr.getLotusUserFullName());
				ApplicantSubListAuditManager.addApplicantSubListAuditBean(audbean);

				request.setAttribute("msg", "Substitute list has been activated.");
