...
public class AddNLESDSupportReferenceCheckRequestHandler extends RequestHandlerImpl {
	public AddNLESDSupportReferenceCheckRequestHandler() {
	...
	public String handleRequest(HttpServletRequest request, HttpServletResponse response)
		...
		else if (form.hasValue("op", "CANDIDATE_DETAILS")) // AJAX CALL
		{
			...
			try {
				NLESDReferenceSSSupportBean ref=null;
				if (form.exists("reference_id"))
					ref = NLESDReferenceSSSupportManager.getNLESDReferenceSSSupportBean(form.getInt("reference_id"));
				else {
					ref = new NLESDReferenceSSSupportBean();
