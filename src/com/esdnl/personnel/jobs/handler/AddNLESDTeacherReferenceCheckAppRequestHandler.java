...
public class AddNLESDTeacherReferenceCheckAppRequestHandler extends PublicAccessRequestHandlerImpl {
	public AddNLESDTeacherReferenceCheckAppRequestHandler() {
