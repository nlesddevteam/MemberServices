...
public class ListVacanciesWithRecommendationSubmittedRequestHandler extends RequestHandlerImpl {

	public ListVacanciesWithRecommendationSubmittedRequestHandler() {
			...
			if (validate_form()) {
				...
				if (zone != null) {
					request.setAttribute("VACANCIES",
							TeacherAllocationVacancyStatisticsManager.getVacanciesWithRecommendationSubmitted(form.get("sy"), zone));
					request.setAttribute("VacancyListTitle", "Vacancies with Recommendation Submitted - "
