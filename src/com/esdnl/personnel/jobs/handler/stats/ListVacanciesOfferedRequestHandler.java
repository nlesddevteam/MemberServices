...
public class ListVacanciesOfferedRequestHandler extends RequestHandlerImpl {

	public ListVacanciesOfferedRequestHandler() {
			...
			if (validate_form()) {
				...
				if (zone != null) {
					request.setAttribute("VACANCIES",
							TeacherAllocationVacancyStatisticsManager.getVacanciesOffered(form.get("sy"), zone));
					request.setAttribute("VacancyListTitle",
							"Vacancies with Current Offers - " + StringUtils.capitaliseAllWords(zone.getZoneName()) + " Region");
