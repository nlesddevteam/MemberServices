...
public class ListVacanciesWithRecommendationApprovedRequestHandler extends RequestHandlerImpl {

	public ListVacanciesWithRecommendationApprovedRequestHandler() {
			...
			if (validate_form()) {
				...
				if (zone != null) {
					request.setAttribute("VACANCIES",
							TeacherAllocationVacancyStatisticsManager.getVacanciesWithRecommendationApproved(form.get("sy"), zone));
					request.setAttribute("VacancyListTitle", "Vacancies with Recommendation Approved - "
