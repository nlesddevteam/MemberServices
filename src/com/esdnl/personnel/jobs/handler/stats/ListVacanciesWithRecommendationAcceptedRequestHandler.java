...
public class ListVacanciesWithRecommendationAcceptedRequestHandler extends RequestHandlerImpl {

	public ListVacanciesWithRecommendationAcceptedRequestHandler() {
			...
			if (validate_form()) {
				...
				if (zone != null) {
					request.setAttribute("VACANCIES",
							TeacherAllocationVacancyStatisticsManager.getVacanciesWithRecommendationAccepted(form.get("sy"), zone));
					request.setAttribute("VacancyListTitle", "Vacancies with Recommendation Accepted - "
