...
public class ListVacanciesShortlistedWithNoRecommendationRequestHandler extends RequestHandlerImpl {

	public ListVacanciesShortlistedWithNoRecommendationRequestHandler() {
			...
			if (validate_form()) {
				...
				if (zone != null) {
					request.setAttribute("VACANCIES",
							TeacherAllocationVacancyStatisticsManager.getVacanciesShortlistedWithNoRecommendation(form.get("sy"),
									zone));
					request.setAttribute("VacancyListTitle",
							"Vacancies Shortlisted for at least 48 hours with No Recommendation - "
