...
public class AddApplicantExperienceOtherRequestHandler extends PersonnelApplicationRequestHandlerImpl {
	public AddApplicantExperienceOtherRequestHandler() {
		this.validator = new FormValidator(new FormElement[] {
				...
				new RequiredFormElement("school_board", "Please specify school"),
