...
public class ViewLatestCovid19VaccinationsRequestHandler extends RequestHandlerImpl {

	public ViewLatestCovid19VaccinationsRequestHandler() {
	...
	public String handleRequest(HttpServletRequest request, HttpServletResponse response)
		...
		if(validate_form()) {
			try {
				...
				ArrayList<Covid19ReportBean> elist = Covid19ReportManager.getLatestCovid19VaccinationsByDays(numdays);
				sb.append("<EMPLOYEES>");
