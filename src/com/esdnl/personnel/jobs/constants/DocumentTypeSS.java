...
public class DocumentTypeSS {
	...
	public static final DocumentTypeSS RESUME = new DocumentTypeSS(124, "Resume");
	public static final DocumentTypeSS COVER_LETTER = new DocumentTypeSS(125, "Cover Letter");
	public static final DocumentTypeSS[] ALL = new DocumentTypeSS[] {
			...
			CERTIFICATES,CODE_OF_CONDUCT,CODE_OF_ETHICS_CONDUCT,COVER_LETTER,COVID19_VAX,COVID19_VAX_BOOSTER,DEGREES,DRIVERS_ABSTRACT,DRIVERS_LICENSE, FIRST_AID, LETTER, 
			OHS_TRAINING,REENTRYPL,RESUME,UNIVERSITY_TRANSSCRIPT , WHMIS,VIOLENCE_HAR_PREVENTION,VULNERABLE_SECTOR_CHECK
	};
