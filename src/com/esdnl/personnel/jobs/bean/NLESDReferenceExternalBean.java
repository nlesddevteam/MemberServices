...
public class NLESDReferenceExternalBean {
	private int id;
	...
	public Integer getTotalScore()
	{
		return(Integer.parseInt(scale1) + Integer.parseInt(scale2)+Integer.parseInt(scale3)+Integer.parseInt(scale4)+Integer.parseInt(scale5)+
				...
				+Integer.parseInt(scale16) + Integer.parseInt(scale17) + Integer.parseInt(scale18) + Integer.parseInt(scale19)+ Integer.parseInt(scale20)
				+ Integer.parseInt(scale21) + Integer.parseInt(scale22)
				);
	...
	public Integer getPossibleTotal(){
		...
		if(Integer.parseInt(scale16) > 0){
			total++;
		}
		if(Integer.parseInt(scale17) > 0){
			total++;
		}
		if(Integer.parseInt(scale18) > 0){
			total++;
		}
		if(Integer.parseInt(scale19) > 0){
			total++;
		}
		if(Integer.parseInt(scale20) > 0){
			total++;
		}
		if(Integer.parseInt(scale21) > 0){
			total++;
		}
		if(Integer.parseInt(scale22) > 0){
			total++;
		}
		return total;
	}
