...
public class NLESDReferenceAdminBean {
	private int id;
	...
	public Integer getTotalScore()
	{
		return(Integer.parseInt(scale1) + Integer.parseInt(scale2)+Integer.parseInt(scale3)+Integer.parseInt(scale4)+Integer.parseInt(scale5)+
				...
				Integer.parseInt(scale11) + Integer.parseInt(scale12)+Integer.parseInt(scale13)+Integer.parseInt(scale14)+Integer.parseInt(scale15)+Integer.parseInt(scale16));
	...
	public String getReferenceScale() {
		String rscale="";
		if(this.referenceScale.equals("5")){
			rscale="4";
		}else{
			rscale=this.referenceScale;
		}
		return rscale;
	}
