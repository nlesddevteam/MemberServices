...
public class AssignmentEducationManager {
	...
	public static Collection<AssignmentEducationBean> getAssignmentEducationBeanCollection(JobOpportunityAssignmentBean aBean)
			throws JobOpportunityException {

		Vector<AssignmentEducationBean> v_opps = null;
		...
		try {
			v_opps = new Vector<AssignmentEducationBean>(5);
	...
	public static AssignmentEducationBean[] getAssignmentEducationBeans(JobOpportunityAssignmentBean aBean)
		...
		return (AssignmentEducationBean[]) getAssignmentEducationBeanCollection(aBean).toArray(
				new AssignmentEducationBean[0]);
	}
