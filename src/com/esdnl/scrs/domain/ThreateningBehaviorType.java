...
public class ThreateningBehaviorType implements Comparable<ThreateningBehaviorType> {
	...
	public ThreateningBehaviorType() {

		super();
	}

	public ThreateningBehaviorType(int typeId) {
	...
	public int compareTo(ThreateningBehaviorType o) {
