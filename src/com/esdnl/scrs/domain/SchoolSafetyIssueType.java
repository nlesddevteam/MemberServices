...
public class SchoolSafetyIssueType implements Comparable<SchoolSafetyIssueType> {
	...
	public SchoolSafetyIssueType() {

		super();
	}

	public SchoolSafetyIssueType(int typeId) {
	...
	public int compareTo(SchoolSafetyIssueType o) {
