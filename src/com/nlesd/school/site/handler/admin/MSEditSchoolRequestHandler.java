...
public class MSEditSchoolRequestHandler extends RequestHandlerImpl {

	public MSEditSchoolRequestHandler() {
...
//********* ADDED BY GEOFF TO ALLOW BUS STAFF TO UPDATE SCHOOL ROUTE DOCS IN SCHOOL PROFILES ONLY AND REDIRECT ACCORDINGLY ******
			...
			if((usr.checkRole("BUSROUTE-POST"))) {
				...
				request.setAttribute("msgOK", "SUCCESS: School updated successfully.");
			...
			request.setAttribute("msgERR", "ERROR: School ID required for editting process.");
		}
