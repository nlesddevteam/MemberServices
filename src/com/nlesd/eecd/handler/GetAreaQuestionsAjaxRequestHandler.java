...
public class GetAreaQuestionsAjaxRequestHandler extends RequestHandlerImpl
{
	public GetAreaQuestionsAjaxRequestHandler() {
			...
			throws ServletException, IOException
	{
		...
		try{
			if(validate_form()) {
				...
				TreeMap<Integer,EECDAreaQuestionBean> list = EECDAreaQuestionManger.getAreaQuestionsAnswers(id,usr.getPersonnel().getPersonnelID());
				if(list.isEmpty()) {
					sb.append("<TAREA>");
					sb.append("<TQUESTION>");
