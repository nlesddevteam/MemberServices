...
public class UpdateVehicleStatusAjaxRequestHandler  extends RequestHandlerImpl {
	public UpdateVehicleStatusAjaxRequestHandler() {
	...
	public String handleRequest(HttpServletRequest request, HttpServletResponse response)
		...
		if (validate_form()) {
			try {
				...
				BussingContractorVehicleManager.updateContractorVehicleStatus(pid, newstatus);
				BussingContractorVehicleBean vbean = BussingContractorVehicleManager.getBussingContractorVehicleById(pid);
				AuditTrailBean atbean = new AuditTrailBean();
				atbean.setEntryType(EntryTypeConstant.CONTRACTORVEHICLESTATUSUPDATED);
				atbean.setEntryId(pid);
				atbean.setEntryTable(EntryTableConstant.CONTRACTORVEHICLE);
				atbean.setEntryNotes("Vehicle (PN:" + vbean.getvPlateNumber() + " SN:" +vbean.getvSerialNumber()  + ") Status Changed To " 
				+ VehicleStatusConstant.get(newstatus).getDescription() + " from " + oldstatus +
