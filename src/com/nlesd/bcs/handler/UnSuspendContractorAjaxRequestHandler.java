...
public class UnSuspendContractorAjaxRequestHandler extends RequestHandlerImpl {
	public UnSuspendContractorAjaxRequestHandler() {
	...
	public String handleRequest(HttpServletRequest request, HttpServletResponse response)
		...
		if (validate_form()) {
			try {
				...
				BussingContractorManager.unsuspendContractorsStatus(pid);
				AuditTrailBean atbean = new AuditTrailBean();
				atbean.setEntryType(EntryTypeConstant.CONTRACTORUNSUSPENDED);
				atbean.setEntryId(pid);
				atbean.setEntryTable(EntryTableConstant.CONTRACTORS);
				atbean.setEntryNotes("Contractor Unsuspended By: " + usr.getPersonnel().getFullNameReverse() + " Notes: " + snotes );
