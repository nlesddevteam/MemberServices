...
public class SuspendContractorVehicleAjaxRequestHandler extends RequestHandlerImpl {
	public SuspendContractorVehicleAjaxRequestHandler() {
	...
	public String handleRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			BussingContractorVehicleManager.suspendContractorVehicle(pid, usr.getPersonnel().getFullNameReverse(),snotes);
			BussingContractorVehicleBean ebean = BussingContractorVehicleManager.getBussingContractorVehicleById(pid);
			AuditTrailBean atbean = new AuditTrailBean();
			atbean.setEntryType(EntryTypeConstant.CONTRACTORVEHICLESUSPENDED);
			atbean.setEntryId(pid);
			atbean.setEntryTable(EntryTableConstant.CONTRACTORVEHICLE);
			atbean.setEntryNotes("Vehicle: Plate Number:" + ebean.getvPlateNumber() + "(" + ebean.getBcBean().getCompany() + ") Suspended By: " + usr.getPersonnel().getFullNameReverse() );
			...
			email.setSubject("NLESD Bussing Contractor Vehicle Has Been Suspended");
