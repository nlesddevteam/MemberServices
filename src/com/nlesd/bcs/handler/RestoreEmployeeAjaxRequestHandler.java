...
public class RestoreEmployeeAjaxRequestHandler extends RequestHandlerImpl{
	public RestoreEmployeeAjaxRequestHandler() {
	...
	public String handleRequest(HttpServletRequest request, HttpServletResponse response)
		...
		if (validate_form()) {
	        ...
	        result = BussingContractorEmployeeManager.restoreContractorEmployee(eid);
	        //update audit trail
			...
			atbean.setEntryNotes("Contractor employee (" + ebean.getFirstName() + ' ' + ebean.getLastName() + ") restored on  " + dateTimeInstance.format(Calendar.getInstance().getTime())
