...
public class SuspendContractorEmployeeAjaxRequestHandler extends RequestHandlerImpl {
	public SuspendContractorEmployeeAjaxRequestHandler() {
	...
	public String handleRequest(HttpServletRequest request, HttpServletResponse response)
		...
		if (validate_form()) {
			try {
				...
				BussingContractorEmployeeManager.suspendContractorEmployee(pid, usr.getPersonnel().getFullNameReverse(),snotes);
				BussingContractorEmployeeBean ebean = BussingContractorEmployeeManager.getBussingContractorEmployeeById(pid);
				AuditTrailBean atbean = new AuditTrailBean();
				atbean.setEntryType(EntryTypeConstant.CONTRACTOREMPLOYEESUSPENDED);
				atbean.setEntryId(pid);
				atbean.setEntryTable(EntryTableConstant.CONTRACTOREMPLOYEE);
				atbean.setEntryNotes("Employee: " + ebean.getLastName() + "," + ebean.getFirstName() + " Has Been Suspended By: " + usr.getPersonnel().getFullNameReverse() );
				...
				email.setSubject("NLESD Bussing Contractor Employee Has Been Suspended");
				...
				email.setBody(VelocityUtils.mergeTemplateIntoString("bcs/employee_suspend.vm", model));
				//email.send();
