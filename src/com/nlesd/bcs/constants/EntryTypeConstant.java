...
public class EntryTypeConstant {
	...
	public static final EntryTypeConstant CONTRACTUNSUSPENDED= new EntryTypeConstant(47, "Contract Unsuspended");
	public static final EntryTypeConstant[] ALL = new EntryTypeConstant[] {
		...
		LETTERONFILEDELETED,EMPLOYEETRAININGUPDATED,CONTRACTUNSUSPENDED
	};
