...
public class UpdateStaffDirectoryContactRequestHandler extends RequestHandlerImpl {

	public UpdateStaffDirectoryContactRequestHandler() {
	...
	public String handleRequest(HttpServletRequest request, HttpServletResponse response)
		...
		if (validate_form()) {
			...
			request.setAttribute("msg", "Contact updated successfully.");
			...
			request.setAttribute("msg", "Contact ID required for editing process.");
		}
