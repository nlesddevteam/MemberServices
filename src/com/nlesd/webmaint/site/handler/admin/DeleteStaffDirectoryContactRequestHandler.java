...
public class DeleteStaffDirectoryContactRequestHandler extends RequestHandlerImpl {

	public DeleteStaffDirectoryContactRequestHandler() {
	...
	public String handleRequest(HttpServletRequest request, HttpServletResponse response)
		...
		if (validate_form()) {
			...
			if (contact != null) {
				...
				request.setAttribute("msg", "Contact [" + contact.getFullName() + "] deleted.");
			}
			else {
				request.setAttribute("msg", "Contact with ID [" + form.getInt("id") + "] could not be found.");
			}
		}
		else {
			request.setAttribute("msg", "Contact ID required for editting process.");
		}
