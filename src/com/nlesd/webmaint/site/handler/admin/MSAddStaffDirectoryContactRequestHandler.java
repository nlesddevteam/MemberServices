...
public class MSAddStaffDirectoryContactRequestHandler extends RequestHandlerImpl {

	public MSAddStaffDirectoryContactRequestHandler() {
	...
	public String handleRequest(HttpServletRequest request, HttpServletResponse response)
		...
		if (validate_form()) {
			...
			request.setAttribute("msgERR", "ERROR: Could not initiate the add staff directory contact process.");
		}
