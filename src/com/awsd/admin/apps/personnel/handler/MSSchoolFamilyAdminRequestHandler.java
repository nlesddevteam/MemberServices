...
public class MSSchoolFamilyAdminRequestHandler implements RequestHandler
{
    ...
    throws ServletException, IOException
  {
    ...
    if(op.equalsIgnoreCase("add"))
    {
      ...
      request.setAttribute("msgOK", "SUCCESS: New School family has been created.");
    ...
    {   
      ...
      request.setAttribute("msgOK", "SUCCESS: School Family has been removed.");
    ...
    else if(op.equalsIgnoreCase("delsch"))
    {
      ...
      else
      {
        throw new SchoolFamilyException("School ID parameter is required for DELSCH operation.");
  		...
  		request.setAttribute("msgOK", "SUCCESS: School has been removed from selected family.");
  ...
  //MODIFY---------------------------------------------------------------------------------------------  
    ...
    else if(op.equalsIgnoreCase("mod"))
    {
      ...
      { 
        ...
        request.setAttribute("msgOK", "SUCCESS: School family has been modified.");
