...
public class GetTravelClaimsApprovedByRegionAjaxRequestHandler extends RequestHandlerImpl {

	public GetTravelClaimsApprovedByRegionAjaxRequestHandler() {
	...
	public String handleRequest(HttpServletRequest request, HttpServletResponse response)
		...
		Integer zoneid = Integer.parseInt(request.getParameter("regionid"));
		TreeMap<Integer, Vector<TravelClaim>> travelclaims = null;
		try {
			if (zoneid == 0) {
				travelclaims = TravelClaimDB.getClaimsApprovedByZoneAllTreeMap();
			}
			else {
