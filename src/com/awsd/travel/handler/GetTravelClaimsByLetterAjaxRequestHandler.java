...
public class GetTravelClaimsByLetterAjaxRequestHandler extends RequestHandlerImpl {

	public GetTravelClaimsByLetterAjaxRequestHandler() {
	...
	public String handleRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			if (searchletter.equals("All")) {
				travelclaims = TravelClaimDB.getClaimsPaidTodayTreeMap();
			}
			else {
				travelclaims = TravelClaimDB.getClaimsPaidTodayLetterTreeMap(searchletter);
			}
