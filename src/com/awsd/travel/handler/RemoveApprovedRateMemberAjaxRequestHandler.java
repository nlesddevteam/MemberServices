...
public class RemoveApprovedRateMemberAjaxRequestHandler extends RequestHandlerImpl {

	public RemoveApprovedRateMemberAjaxRequestHandler() {
		...
		if (validate_form()) {
			try {
				...
				for(String s: ids) {
					...
					RoleDB.deleteRoleMembership(r,PersonnelDB.getPersonnel(Integer.parseInt(s)));
				}
			}catch (Exception e) {
				msg=e.getMessage();
