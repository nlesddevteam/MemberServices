...
public class AddAdditionalGoalRequestHandler extends RequestHandlerImpl {

	public AddAdditionalGoalRequestHandler() {
	...
	public String handleRequest(HttpServletRequest request, HttpServletResponse response)
		...
		if (policyRead == null) {
			...
			request.setAttribute("PPGP", PPGPDB.getPPGP(usr.getPersonnel(), form.get("sy")));
