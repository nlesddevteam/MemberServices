...
public class DeleteGrowthPlanTaskAjaxRequestHandler extends RequestHandlerImpl {
	public DeleteGrowthPlanTaskAjaxRequestHandler() {
	...
	public String handleRequest(HttpServletRequest request, HttpServletResponse response)
		...
		if ((policyRead == null)
			...
			if (form.exists("gid")) {
				...
				if(PPGPDB.deletePPGPGoalTask(form.getInt("gid"))){
					message="SUCCESS";
				}else{
					message="Could not delete task from database";
				}
