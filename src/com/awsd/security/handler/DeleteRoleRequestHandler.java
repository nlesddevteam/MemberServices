...
public class DeleteRoleRequestHandler implements RequestHandler
{
    ...
    throws ServletException, IOException
  {
    ...
    try
    {
      ...
      if(request.getParameter("confirmed") != null)
      {
        ...
        if(flag)
        {
          request.setAttribute("msg", "Role deleted successfully.");
          request.setAttribute("deleted", new Boolean(true));
        }
        else
        {
          request.setAttribute("msg", "Role deletion unsuccessful.");
        }
      }
      else
      {
