...
public class MSModifyRoleMembershipRequestHandler implements RequestHandler
{
    ...
    if(op != null)
    {
      if(op.equals("ADD"))
      {
      	...
      	for(int i=0; i < ids.length; i++){
      		...
      		request.setAttribute("msgOK", "SUCCESS: User successfully added.");
      	}
      }
      else if(op.equals("REMOVE"))
      {
      	...
      	for(int i=0; i < ids.length; i++){
      		...
      		request.setAttribute("msgOK", "SUCCESS: User successfully removed.");
      	}
      } else {
    	  request.setAttribute("msgERR", "ERROR: There was a problem adding the user. Please try again..");
      }
    }
