...
public class ModifyRoleRequestHandler implements RequestHandler
{
    ...
    throws ServletException, IOException
  {
    ...
    try
    {
      ...
      if(request.getParameter("confirmed") != null)
      {
        ...
        if(flag)
        {
          request.setAttribute("msg", "Role modified successfully.");
          request.setAttribute("modified", new Boolean(true));
        }
        else
        {
          request.setAttribute("msg", "Role modification unsuccessfully.");
        }
