...
public class DeletePermissionRequestHandler implements RequestHandler
{
    ...
    throws ServletException, IOException
  {
    ...
    try
    {
      ...
      if(request.getParameter("confirmed") != null)
      {
        ...
        if(flag)
        {
          request.setAttribute("msg", "Permission deleted successfully.");
          request.setAttribute("deleted", new Boolean(true));
        }
        else
        {
          request.setAttribute("msg", "Permission deletion unsuccessful.");
        }
      }
      else
      {
