...
public class MSAddPermissionRequestHandler implements RequestHandler
{
    ...
    throws ServletException, IOException
  {
    ...
    try
    {
      ...
      { 
        ...
        if(added)
        {
          request.setAttribute("msgOK", "Permission Added Successfully.");  
        }
        else
        {
          request.setAttribute("msgERR", "Permission Adding Unsuccessful.");  
        }
      }
    }
