...
public class MSClosureStatusAdminRequestHandler implements RequestHandler {
	...
	public String handleRequest(HttpServletRequest request, HttpServletResponse response)
		...
		if (op.equalsIgnoreCase("add")) {
			...
			if (desc != null) {
				...
				request.setAttribute("msgOK", "SUCCESS: New status assigned.");
			}
			else {
			...
			request.setAttribute("msgOK", "SUCCESS: Status deleted.");
			...
			request.setAttribute("msgOK", "SUCCESS: Status updated.");
