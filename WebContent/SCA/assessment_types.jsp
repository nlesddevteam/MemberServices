...
<%
  ...
  AssessmentType[] types = SCAManager.getAssessmentTypeBeans();
%>
...
<tr><td height="480" valign="top">
  ...
  <h2 class='body_title'>Assessment Types</h2>
  <div width="100%" align="right"><a href="addAssessmentType.html">Add Assessment Type</a></div>
	<!-- Mainbody content here -->
	<%if(types.length > 0){%>
