...
<tr><td height="480" valign="top">
  ...
  <h2 class='body_title'>Add Referral Reason Code</h2>
	<!-- Mainbody content here -->
  ...
  <%}%>
	<form id="frmWaitListAdd" action="addReferralReasonCode.html" method="post">   
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="padding:5px;">
      ...
      <tr>
        <td class="displayHeaderTitle" valign="middle" align="right" width='150px'><span class="requiredStar">*&nbsp;</span>Reason Description</td>
        <td>
            <input type="text" name="reason_desc" id="reason_desc" style="width:175px;" class="requiredInputBox" value="">
        </td>
      </tr>
