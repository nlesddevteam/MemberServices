...
<table class="schoolAdminTable table table-sm table-bordered responsive" width="100%" style="font-size:12px;background-color:White;">
					...
					<th width="20%">ASSISTANT PRINCIPAL(s)</th>
				...
				<tbody>                    
					<%sch_iter = family.getSchoolFamilySchools().iterator();
                        ...
                        <%=(school.getSchoolPrincipal()!= null)?school.getSchoolPrincipal().getFullName().toLowerCase():"N/A"%>
                       </td>
                        <td width="20%" style="text-transform:capitalize;">
                              <%
                              	if((aps != null) && (aps.length > 0)){
                              		for(int i=0; i < aps.length; i++) { %>
                              <%=aps[i].getFullName().toLowerCase() %><br/>
