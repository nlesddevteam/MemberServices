...
Special applications for administering staff, permissions, roles, and categories.<br/><br/>
		...
		<a href="/MemberServices/Administration/PersonnelAdmin/personnel_admin_view.jsp" onclick="loadingData();">
		...
		<div class="menuIconImage">
		<a href="/MemberServices/Administration/SchoolAdmin/school_admin_view.jsp" onclick="loadingData();">
		...
		<div class="menuIconImage">
		<a href="/MemberServices/Administration/SchoolAdmin/schoolfamilyadmin.jsp" onclick="loadingData();">
		<img src="StaffRoom/includes/img/fos-off.png" class="img-swap menuImage" border=0 title="School Family (DOS) Assignment"/>
		</a>
		</div>
		<div class="menuIconImage">
		<a href="/MemberServices/Administration/SchoolAdmin/schoolsystemadmin.jsp" onclick="loadingData();">
...
<!-- ATIPP information -->	
		...
		<div class="menuIconImage">
			<a href="StaffRoom/atipp.jsp" onclick="loadingData();">
...
<!-- Social media Awareness -->
		...
		<div class="menuIconImage">
			<a href="StaffRoom/socialmedia.jsp" onclick="loadingData();">
...
<!-- Google GSuite -->
		...
		<div class="menuIconImage">
				<a href="StaffRoom/googleapps.jsp" onclick="loadingData();">
...
<!-- Payroll Resources -->
		...
		<div class="menuIconImage">
				<a href="StaffRoom/payrollresources.jsp" onclick="loadingData();">
...
<!-- Staff Resources -->
		...
		<div class="menuIconImage">
				<a href="StaffRoom/staffresources.jsp" onclick="loadingData();">
...
<!-- Unionized Staff Seniority Reports -->	
		...
		<div class="menuIconImage">
				<a href="StaffRoom/staffseniorityreports.jsp" onclick="loadingData();">
...
<!-- Weather and Road Conditions -->					
		<div class="menuIconImage">
			<a href="StaffRoom/weather.jsp" onclick="loadingData();">
...
<!-- TRAINING - ALL STAFF -->			
		...
		<div class="menuIconImage">
			<a href="Training/" onclick="loadingData();">
...
<!-- COVID 19-UPDATES - ALL STAFF -->					
		<div class="menuIconImage">
			<a href="covid19/index.jsp" onclick="loadingData();">
...
<!-- Teacher / Secretary Profile System -->
		<esd:SecurityAccessRequired permissions="PERSONNEL-PROFILE-TEACHER-VIEW,PERSONNEL-PROFILE-SECRETARY-VIEW">
			<div class="menuIconImage">
				<a href="Profile/Teacher/" onclick="loadingData();">
...
<!-- Cayenta EServe -->
			...
			<div class="menuIconImage">
				<a href="https://sdsweb.nlesd.ca/sds/eserve/login.xsp" target="_blank">
...
<!-- PowerSchool SmartFind -->
			...
			<div class="menuIconImage">
				<a href="https://nlesd.sfe.powerschool.com/homeAction.do" target="_blank"> 
...
<!-- PowerSchool Admin -->
			...
			<div class="menuIconImage">
				<a href="https://nlsis.powerschool.com/admin/pw.html" target="_blank"> 
...
<!-- PowerSchool Teacher -->
			...
			<div class="menuIconImage">
				<a href="https://nlsis.powerschool.com/teachers/pw.html" target="_blank"> 
...
<!-- PS Counts -->					
			<esd:SecurityAccessRequired roles="SENIOR EDUCATION OFFICIER,ASSISTANT DIRECTORS,ADMINISTRATOR,ADHR,DIRECTOR">
				<div class="menuIconImage">                              
					<a href="PSCounts/viewPSCounts.html" onclick="loadingData();">
...
<!-- Personnel Package-->
			<esd:SecurityAccessRequired
				...
				<div class="menuIconImage">
					<a href="Personnel/admin_index.jsp" onclick="loadingData();"> 
...
<!-- Kindergarten Registration -->
			<esd:SecurityAccessRequired permissions="KINDERGARTEN-REGISTRATION-ADMIN-VIEW,KINDERGARTEN-REGISTRATION-SCHOOL-VIEW">
				<div class="menuIconImage">
					<a href="schools/registration/kindergarten/admin/index.html" onclick="loadingData();">
...
<!-- ICF Registration -->
			<esd:SecurityAccessRequired permissions="ICF-REGISTRATION-ADMIN-VIEW">
				<div class="menuIconImage">                              
					<a href="schools/registration/icfreg/admin/index.html" onclick="loadingData();">
			...
			<esd:SecurityAccessRequired permissions="ICF-REGISTRATION-SCHOOL-VIEW">
				<div class="menuIconImage">                              
					<a href="schools/registration/icfreg/admin/schoolindex.html"  onclick="loadingData();">
...
<!-- PD Calendar -->
			<esd:SecurityAccessRequired permissions="CALENDAR-VIEW">
				<div class="menuIconImage">
					<a href="PDReg/viewDistrictCalendar.html"  onclick="loadingData();"> 
...
<!-- Professional Learning PLAN  --> 
			<esd:SecurityAccessRequired permissions="PPGP-VIEW">	
					<div class="menuIconImage">
						<a href="PPGP/ppgpPolicy.html"  onclick="loadingData();">
...
<!-- Pay Advice Admin -->
			<esd:SecurityAccessRequired permissions="PAY-ADVICE-ADMIN">
				<div class="menuIconImage">
					<a href="PayAdvice/index.jsp" onclick="loadingData();">
...
<!-- Pay Advice for Teachers -->
			<esd:SecurityAccessRequired permissions="PAY-ADVICE-NORMAL">
				<div class="menuIconImage">
					<a href="PayAdvice/viewTeacherPaystubs.html">
...
<!-- Student Travel Request System -->
			<esd:SecurityAccessRequired permissions="STUDENT-TRAVEL-ADMIN-VIEW,STUDENT-TRAVEL-PRINCIPAL-VIEW">
				<div class="menuIconImage">
					<a href="student/travel/" onclick="loadingData();">
...
<!-- Travel Claim System  -->
			<esd:SecurityAccessRequired permissions="TRAVEL-EXPENSE-VIEW">
				<div class="menuIconImage">
					<a href="Travel/viewTravelClaimSystem.html" onclick="loadingData();">
...
<!-- Busing Contractor System -->	
			<esd:SecurityAccessRequired permissions="BCS-SYSTEM-ACCESS">
				<div class="menuIconImage">
					<a href="BCS/index.html" onclick="loadingData();">
...
<!-- BUS PLANNER -->
			<esd:SecurityAccessRequired roles="ADMINISTRATOR,PRINCIPAL,VICE PRINCIPAL,SCHOOL SECRETARY">
				<div class="menuIconImage">                              	
					<a href="https://nlesd.mybusplanner.ca/default" target="_blank">
...
<!-- EECED -->
			<esd:SecurityAccessRequired roles="PRINCIPAL,VICE PRINCIPAL">
				<div class="menuIconImage">                              	
					<a href="EECD/schoolAdminViewApprovals.html" onclick="loadingData();">
			...
			<esd:SecurityAccessRequired permissions="EECD-VIEW">
				<div class="menuIconImage">                              
					<a href="EECD/viewEECD.html" onclick="loadingData();">
			...
			<esd:SecurityAccessRequired permissions="EECD-VIEW-ADMIN,EECD-VIEW-SHORTLIST">
				<div class="menuIconImage">                              
					<a href="EECD/adminViewAreas.html" onclick="loadingData();">
...
<!-- Office Staff Update -->
		<esd:SecurityAccessRequired
			...
			<div class="menuIconImage">
				<a href="StaffRoom/StaffDirectory/staff_directory.jsp" onclick="loadingData();">
...
<!-- Tender Posting System -->
		<esd:SecurityAccessRequired permissions="TENDER-ADMIN,TENDER-EDIT,TENDER-VIEW">
			<div class="menuIconImage">
				<a href="Tenders/viewTenders.html" onclick="loadingData();">
...
<!-- Admin School Profile Update -->
		<esd:SecurityAccessRequired roles="ADMINISTRATOR,PRINCIPAL,VICE PRINCIPAL,SCHOOL SECRETARY">
			<div class="menuIconImage">
				<a href="StaffRoom/SchoolDirectory/school_profile.jsp" onclick="loadingData();">
...
<!-- Bus Route Update -->
		<esd:SecurityAccessRequired roles="ADMINISTRATOR,BUSROUTE-POST">
			<div class="menuIconImage">
				<a href="StaffRoom/BusRoutes/school_directory_bus_routes.jsp" onclick="loadingData();">
...
<!-- School Review System--> 
		<esd:SecurityAccessRequired roles="ADMINISTRATOR,SCHOOL-REVIEW-ADMIN">
			<div class="menuIconImage">                              	
				<a href="SchoolReviews/viewSchoolReviews.html" onclick="loadingData();">
...
<!-- Weather Central -->
		<esd:SecurityAccessRequired permissions="WEATHERCENTRAL-PRINCIPAL-ADMINVIEW">
			<div class="menuIconImage">
				<a href="SchoolStatus/viewWeatherCentralAdmin.html" onclick="loadingData();">
...
<!-- Web Maintenance -->
 ...
 <!-- News Postings -->      	
	          	...
	          	<div class="menuIconImage">      
	          		<a href="/MemberServices/WebUpdateSystem/NewsPostings/viewNewsPostings.html" onclick="loadingData();">
...
<!-- Meeting Minutes -->				
				...
				<div class="menuIconImage">     
	          		<a href="/MemberServices/WebUpdateSystem/MeetingMinutes/viewMeetingMinutes.html" onclick="loadingData();">
 ...
 <!-- Meeting Highlights -->      	
				 ...
				 <div class="menuIconImage">
	          		<a href="/MemberServices/WebUpdateSystem/MeetingHighlights/viewMeetingHighlights.html" onclick="loadingData();">
...
<!-- Banner Postings -->      	
	          	<esd:SecurityAccessRequired permissions="WEBMAINTENANCE-VIEW,WEBMAINTENANCE-ANNOUNCEMENTS">
	          	<div class="menuIconImage">    
	          		<a href="/MemberServices/WebUpdateSystem/Banners/viewBanners.html" onclick="loadingData();">
...
<!-- Blog (Not currently Used)-->      	
	          	...
	          	<div class="menuIconImage">     
	          		<a href="/MemberServices/WebUpdateSystem/Blogs/viewBlogs.html" onclick="loadingData();">
...
<!-- Policy Postings -->      	
	          	...
	          	<div class="menuIconImage">     
	          		<a href="/MemberServices/WebUpdateSystem/Policies/viewPolicies.html" onclick="loadingData();">
...
<!-- Staff HelpCentre-->
		<div class="menuIconImage">
			<a href="StaffRoom/helpcentre.jsp" onclick="loadingData();">
