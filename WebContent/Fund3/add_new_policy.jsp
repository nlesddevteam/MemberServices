	...
	<body style="margin:20px;">
		...
		<table width="1000px" border="0" cellspacing="0" cellpadding="0" align="center" style="border: 3px solid Black; background-color: White;">
			...
			<tr align="center">
				...
				<tr>
				<th colspan='2' align='center' class='fund3addscreentextnb'>Add New Policy</th>
				</tr>
				<tr>
				<td class='fund3formtext'>Link Text:</td>
				<td><input type='text' id='linktext' name='linktext' required></td>
				</tr>
				<tr>
				<td class='fund3formtext'>File:</td>
				<td><input type='file' id='filename' name='filename' required></td>
				</tr>
				<tr>
				...
				<td align="center" colspan='2'>
					<br />
					<input type="submit" value="Add New Policy" class="btnExample">
					&nbsp;&nbsp;&nbsp;&nbsp;
