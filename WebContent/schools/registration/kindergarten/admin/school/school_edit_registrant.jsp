...
<style>
  ...
  <div align='center' style='font-size:14pt;font-weight:bold;color:#004178;;padding-bottom:15px;'>
  		${kr.registration.schoolYear} ${kr.school} Registration Information ( <span style="color:Red;">EDITING</span> )<br/>
  ...
  <form method='post' action="<c:url value='/schools/registration/kindergarten/admin/school/updateKindergartenRegistrant.html'/>" class="was-validated">
