<!-- NLESD.CA ICF REGISTRATION DECORATOR FILE (C) 2023  -->	
...
<!-- META TAGS  -->			
		...
		<title><decorator:title default="ICF Registration" /></title>
...
<!-- CSS STYLESHEET FILES CDN -->
		...
		<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto"/>		
  		...
  		<link rel="stylesheet" href="/MemberServices/schools/registration/icfreg/registration/includes/css/icfreg.css?ver=${todayVer}"/>
...
<!-- JAVASCRIPT FILES LOCAL- ANY MODIFICATIONS DO HERE-->			
		...
		<script src="/MemberServices/schools/registration/icfreg/registration/includes/js/icfregmain.js?ver=${todayVer}"></script>
...
<!-- GOOGLE ANALYTICS -->
	...
	<div id="loadingSpinner" style="display:none;z-index:99999;"><div id="spinner">
	<img src="/MemberServices/schools/registration/icfreg/registration/includes/img/loading4.gif" width="200" border=0><br/>Loading data, please wait...</div></div>
	

	<!-- PAGE BODY -->	
			<div class="mainContainer">
				<div class="container-fluid">	
				 <img src="/MemberServices/schools/registration/icfreg/registration/includes/img/header.png" style="width:100%;"/>
						...
						<div class="menuFooter no-print" align="center">
							<div class="serverClock" align="center">								
									<div align="center" style="border:1px solid red;width:210px;background:white;margin:0 auto;">
									<div style="background:red;color:white;width:100%;"><i class="far fa-clock"></i> CURRENT SERVER TIME <i class="far fa-clock"></i></div> 
									<span style='font-weight:bold; color:red;font-size:14px;'><span id="kinderTime"></span></span>
									</div>
							</div>
...
<script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
		  ...
		  <div class="copyright">ICF Registration System 1.0 &copy; 2023 NLESD &middot; All Rights Reserved.</div>		
...
<script>
//Get kinderTime live clock, set from server then continue.
var serverTime = "<%=Calendar.getInstance().getTimeInMillis() %>";
...
setInterval(function () {
  ...
  document.getElementById('kinderTime').innerHTML = month + "/" + day + "/" + year + " &nbsp;&nbsp; " +hours + ':' + minutes + ':' + seconds + " " + ampm;
}, 1000);
