<!-- NLESD.CA ICF REGISTRATION ADMIN DECORATOR FILE (C) 2023  -->	
...
<!-- CSS STYLESHEET FILES CDN -->
 ...
 <!--  CSS LOCAL FILES - ANY MODIFICATIONS DO HERE-->  		
  		<link rel="stylesheet" href="/MemberServices/schools/registration/icfreg/admin/includes/css/icfreg.css?ver=${todayVer}"/>				
...
<!-- JAVASCRIPT FILES LOCAL- ANY MODIFICATIONS DO HERE-->			
		<script src="/MemberServices/schools/registration/icfreg/admin/includes/js/icfregadin.js?ver=${todayVer}"></script>	
	...
	<img src="/MemberServices/schools/registration/icfreg/admin/includes/img/loading4.gif" width="200" border=0><br/>Loading data, please wait...</div></div>
	

	<!-- PAGE BODY -->	
			<div class="mainContainer">
				<div class="container-fluid">	
				<img src="/MemberServices/schools/registration/icfreg/admin/includes/img/header.png" style="width:100%;"/>			
