...
<html>
  ...
  <head>
    <TITLE>View ICF Registrants</title>
...
$('document').ready(function(){		
		...
		<div align='center' style='font-size:14pt;font-weight:bold;color:#004178;;padding-bottom:15px;'>
	  	ICF Registrants<br/>  
  	 	<div style="font-size:14px;">
  			${regbean.icfRegPerSchoolYear} Registration Period<br/>${regbean.getStartDateFormatted()} - ${regbean.getEndDateFormatted()}<br/>Total: <span style="color:red;font-weight:normal;" id="spancount">${regbean.icfRegCount}</span>
		</div>			
  		</div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <button type="button" class="btn btn-sm btn-danger" id="btndeleteregistrant">Delete</button>
