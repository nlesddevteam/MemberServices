...
<html>
  ...
  <head>
	...
	<!-- META TAGS  -->
		...
		<meta name="keywords" content="Covid-19,NLESD,Newfoundland and Labrador English School District,Eastern School District,English School District,Avalon School District,Vista School District,Burin School District,NOVA Central School District,Western School District,Labrador School District,Newfoundland Education,Education newfoundland,Schools in Newfoundland,Newfoundland Schools,St. John's,Corner Brook,Gander,Happy Valley-Goose Bay,School Board,School Board Trustees,Newfoundland School Board">  
		
		<title><decorator:title default="COVID-19 (Coronavirus)" /></title>
	...
	<!-- CSS STYLESHEET FILES -->	   
		...
		<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.7.0/css/all.css" integrity="sha384-lZN37f5QGtY3VHgisS14W3ExzMWZxybE1SJSEsQp9S+oqd12jhcu+A56Ebc1zFSJ" crossorigin="anonymous">
  		<link rel="stylesheet" href="/MemberServices/covid19/includes/css/covid.css">			
		<link rel="shortcut icon" href="/MemberServices/covid19/includes/img/favicon.ico">	
	...
	<!-- CDN JAVASCRIPT> -->	
	 ...
	 <!-- LOCAL JAVASCRIPT FILES -->		
		<script src="/MemberServices/covid19/includes/js/covid.js"></script>	 	
			...
			<div class="container-fluid">		
				<div class="row">				  
				  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align:center;">
				   	<img class="topLogoImg" src="/MemberServices/covid19/includes/img/header.png" title="Newfoundland and Labrador English School District">
				  </div>				  
				</div>		
			</div>
...
<br/><br/>Feel free to make contact with any of the following regional HR offices:
 <br/><br/>
<ul>
<li>AVALON REGION - <a href="mailto:hravalon@nlesd.ca">hravalon@nlesd.ca</a>
<li>CENTRAL REGION - <a href="mailto:hrcentral@nlesd.ca">hrcentral@nlesd.ca</a>
<li>LABRADOR REGION - <a href="mailto:hrlabrador@nlesd.ca">hrlabrador@nlesd.ca</a>
<li>WESTERN REGION - <a href="mailto:hrwest@nlesd.ca">hrwest@nlesd.ca</a>
 </ul>    </div>
...
<!-- FOOTER AREA -->		
	...
	<div class="mainFooter no-print"> 
		...
		<div class="row" >
		 ...
		 &copy; 2020 Newfoundland and Labrador English School District &middot; All Rights Reserved 
		 </div>
