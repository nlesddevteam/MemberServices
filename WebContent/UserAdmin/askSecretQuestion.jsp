...
<html>
    ...
    <form id="set_question_form" method="post" action="askSecretQuestion.html">
                            ...
                            <td>
                              <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                  ...
                                  <td width="*" ><input type="text" name="answer" id="answer" class="requiredinput" value="" style="width:300px;"></td>
                                </tr>
                              </table>
                            </td>
                          </tr>
