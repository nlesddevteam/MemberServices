...
<html>
	...
	<head>
		...
		<meta name='menu' content='view-note-audit' />
		<title>Note Audit</title>
		...
		<script type="text/javascript">
			$('document').ready(function() {
				...
				$('#view-note').click(function() {
					document.location.href = 'viewNote.html?note-id=${note.noteId}';
				});
	...
	<body>
		<div class='title'><span>Note Audit Trail</span></div>
		<br />
		<div>
			<table cellspacing='0' cellpadding='0' border='0' class='data-list'>
				...
				<tbody>
					<c:choose>
						...
						<c:otherwise>
							<tr class='user-message'><td colspan='4'>No note audit trail found.</td></tr>
						</c:otherwise>
					</c:choose>
				</tbody>
				<tfoot>
