...
<html>
	...
	<head>
		...
		<script type="text/javascript">
			...
			function auditdocument(id) {
				//popup('admin/viewNote.html?note-id='+id, 600, 600);
				document.location.href = 'viewDocAudit.html?doc-id='+id;
			}

			function deletedocument(id) {
				//popup('admin/viewNote.html?note-id='+id, 600, 600);
				document.location.href = 'deleteDocument.html?doc-id='+id;
			}
		</script>
												...
												<tbody>
													<c:forEach items="${m.value}" var="doc">
														<tr class='note'>
															...
															<td>${doc.dateAdded}</td>
															<td class='options'><a href='javascript:readdocument(${doc.documentId})'>read</a> | <a href='javascript:auditdocument(${doc.documentId})'>audit</a> | <a href='javascript:deletedocument(${doc.documentId})'>delete</a></td>
														</tr>
													</c:forEach>
												</tbody>
												<tfoot>
