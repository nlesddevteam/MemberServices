...
$(document).ready(function() {
	...
	<div id="printJob">	
		 <div class="BCSHeaderText">View Contractor Employee Convictions</div>	
		 ...
		 <p>
			  ...
			  <p>
			  	<select id="selectcon" name="selectcon">
			  		...
			  		<c:forEach items="${convicttypes}" var="rule">
			  					<option value='${rule.key}'>${rule.value}</option>
			  		</c:forEach>
			  	</select>
			  	</p>
			  	<p>
			  	<input type="button" value="Get Report Data" onclick="getContractorsEmployeeConvictions();">
