...
$(document).ready(function() {
	...
	<div id="printJob">	
		<div class="BCSHeaderText">View Contractor Vehicles</div>
			  ...
			  <p>
			  	...
			  	<p>
			  	<input type="button" class="menuBCS" value="Get Report Data" class="menuBCS" onclick="getContractorsVehicles();">
