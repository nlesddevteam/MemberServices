...
$(document).ready(function() {
	...
	<div id="printJob">	
		 <div class="BCSHeaderText">View Contractor Employee Training</div>	
		 ...
		 <p>
			  ...
			  <p>
			  	...
			  	<p>
			  	<input type="button" value="Get Report Data" class="menuBCS" onclick="getContractorsEmployeeTraining();">
