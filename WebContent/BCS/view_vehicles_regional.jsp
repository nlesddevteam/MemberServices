...
$(document).ready(function() {
	...
	<div id="printJob">	
		 <div class="BCSHeaderText">View ${companyname} Vehicles</div>			 
    		...
    		<div class="alert alert-success" id="details_success_message" style="display:none;margin-top:10px;margin-bottom:10px;padding:5px;"></div>
			 <div id="BCS-Search">
	<form action="viewContractorVehiclesRegDetails.html" method="post" >
	...
	<td style="width:150px;padding:5px;">		
		...
		<tr>
		<td colspan=2>
		<input type="button" class="menuBCS" value="Get Vehicles" onclick="return checkregionvaluesvehicles();" >
		</td></tr></table>
