                  ...
                  <table width="100%" cellpadding="0" cellspacing="6" border="0">
                    <tr>
                      <td colspan="3" align="right">
                        <img style="padding-right:10px;padding-bottom:2px;" src="images/printer.gif" alt="Print claim." style="cursor:hand;" 
                                onclick="openWindow('PRINT_CLAIM', 'print_calpopup.jsp',170, 170, 0);"><br>
                      </td>
                    </tr>
                    <tr>
                      <td class="label" width="33%">SIN</td>
                    ...
                    %>    <tr>
                            <td class="content" width="33%"><%=profile.getSIN()%></td>
                            ...
                            <td class="content" width="*">
                              <img src="images/btn_view_01.gif"
                                   ...
                                   onclick="document.location.href='myROERequest.html?op=VIEW&rid=<%=roer.getRequestID()%>';"><br>
                            </td>
                          </tr>
                    <%   }
                      }else{%>
