...
<!-- HOME MENU-->   
					    	...
					    	<a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-file"></span> File <span class="caret"></span></a>
					    	 <ul class="dropdown-menu multi-level">					    	 
					          ...
					          <li><a href='#' id="printingFct" title='Print this page (pre-formatted)' onclick="jQuery('#printJob').print({prepend : '<div align=center style=margin-bottom:15px; id=prnHeader1><img width=400 src=includes/img/nlesd-colorlogo.png><br/><br/><b>Human Resources Profile System</b><br/><br/></div>'});"><span class="glyphicon glyphicon-print"></span> Print Page</a></li>
                                <li><a href="/employment/ssmgmtpositions.jsp">Back to Positions</a></li>
					          	</ul>
					        </li> 
					        ...
					        <li class="dropdown" id="menuNormal">
					          <a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-education"></span> Education/Preferences<span class="caret"></span></a>
					          	<ul class="dropdown-menu multi-level">
										...
										<li><a onclick="loadingData()" href="/MemberServices/Personnel/applicant_registration_step_5_ss.jsp">Education Test</a></li>
...
<!-- HOME MENU-->   
				...
				<%} %>
					          <li><a href='#' title='Print this page (pre-formatted)' onclick="jQuery('#printJob').print({prepend : '<div align=center style=margin-bottom:15px; id=prnHeader1><img width=400 src=includes/img/nlesd-colorlogo.png><br/><br/><b>Human Resources Profile System</b><br/><br/></div>'});">Print Page</a></li>
                <%if(session.getAttribute("APPLICANT") != null){%>	
                              <li class="divider"></li>
