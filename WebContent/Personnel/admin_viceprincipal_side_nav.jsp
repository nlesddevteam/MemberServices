                    ...
                    <table width="178" cellpadding="0" cellspacing="0" border="0" style="border-style: solid; border-color: #EBEBEB; border-width: 1px;">
                      ...
                      <tr>
                        <td width="178" align="left" valign="top" style="background-color: #FFFFFF;" colspan="2">
                          ...
                          &nbsp;<span class="linkText">&gt;&nbsp;</span><a href="principalJobShortlists.html" class="homeSideNavLink">View Job Short Lists</a><BR>
                          
                          &nbsp;<span class="linkText">&gt;&nbsp;</span><a href="principalSubListShortlists.html" class="homeSideNavLink">View Sub List Shortlists</a><BR>
                          
                          &nbsp;<span class="linkText">&gt;&nbsp;</span><a href="availability_list.jsp" class="homeSideNavLink">Student Assistant List</a><BR>
                          <!-- Global Spacer for Alignment -->
                          <img src="images/spacer.gif" width="1" height="5"><BR>
                          <!-- Global Spacer for Alignment -->
