...
<style>
    ...
    <div class="panel panel-success">
  	<div class="panel-heading">Teacher Candidate Reference Check for <b><%= profile.getFullNameReverse() %>.</b></div>
	...
	<div class="panel panel-success">
  	...
  	<div class="panel-body">
  	The following reference checks should have been completed and attached to the teacher recommendation form.																		
			<div class="table-responsive"> 
				...
				<thead>
				 ...
				 <tbody>
				     <tr>
					    <td>Q1.</td>
					    <td>Did the candidate ask permission to use your name as a reference?<br/><span class="tableAnswer"><%=ref.getQ1() %></span></td>
					</tr>
					<tr>
					    <td>Q2.</td>
					    <td>How long have you known this teacher?<br/><span class="tableAnswer"><%=ref.getQ2() %></span></td>
					</tr>					
					<tr>
					    <td>Q3.</td>
					    <td>How long have they worked in your school?<br/><span class="tableAnswer"><%=ref.getQ3() %></span></td>
					</tr>
					<tr>
					    <td>Q4.</td>
					    <td>What has been their most recent assignment?<br/><span class="tableAnswer"><%=ref.getQ4() %></span></td>
					</tr>
					<tr>
					    <td>Q5.</td>
					    <td>Did this teacher complete a professional learning plan?<br/><span class="tableAnswer"><%=ref.getQ5() %></span></td>
					</tr>
					<tr>
					    <td>Q6.</td>
					    <td>Was the learning plan successfully followed and completed?<br/><span class="tableAnswer"><%=ref.getQ6() %></span></td>
					</tr>						
...
<%if(refscale.equals("4") || refscale.equals("5")){%>
																	...
																	(<%=val4%>-Proficient, <%=val3%>-Competent, <%=val2%>-Developing Competence and <%=val1%>-Needs Improvement)
																							...
																							<%}%>
	<div align="left" style="padding-top:5px;"><a href="includes/rubric.pdf" class="btn btn-xs btn-default" target="_blank">View Scoring Rubric</a></div>
	<div class="table-responsive">
										    	...
										    	<thead>
												 ...
												 <tbody>
													 ...
													 <tr>
													  ...
													  <tr>
													    <td>S15.</td>
													    <td>This teacher demonstrates and utilizes appropriate formative accessment strategies:</td>
...
<%if(refscale.equals("4") || refscale.equals("5")){%>
	...
	(<%=val4%>-Proficient, <%=val3%>-Competent, <%=val2%>-Developing Competence and <%=val1%>-Needs Improvement)	
	<%}else{%>
	On a scale of <%=val1%> to <%=val5%> please rate the teacher on the following statements (<%=val5%>-Proficient, <%=val4%>-Competent, <%=val3%>-Developing Competence, <%=val2%>-Needs Improvement and <%=val1%>-N/A)
																							<%}%>	
	<div align="left" style="padding-top:5px;"><a href="includes/rubric.pdf" class="btn btn-xs btn-default" target="_blank">View Scoring Rubric</a></div>
	<div class="table-responsive">
	<table class="table table-striped table-condensed" style="margin-top:10px;font-size:12px;padding-top:3px;border-top:1px solid silver;">
	<thead>
												 ...
												 <tbody>
												     <tr>
													    ...
													    <%=ref.getScale17().equals("-1") ? "N/A" : ref.getScale17() %>
													    </td>
													 </tr>						
													 <tr>
													    <td>S18.</td>
													    ...
													    <td class="tableAnswer">
													    <%=ref.getScale18().equals("-1") ? "N/A" : ref.getScale18() %>
													    </td>
													 </tr>
													  <tr>
													    <td>S19.</td>
											    ...
											    <thead>
												 ...
												 <tbody>
													 ...
													 <tr>
														...
														<span class="tableAnswer"><%= (!StringUtils.isEmpty(ref.getQ7Comment())?ref.getQ7Comment():"none") %></span>	
														</td>													    
													 </tr>
												</tbody>
										</table>
