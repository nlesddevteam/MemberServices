...
<body>
  ...
  <esd:SecurityCheck permissions="PERSONNEL-PRINCIPAL-VIEW" />


<div class="panel-group" style="padding-top:5px;">                               
	               	<div class="panel panel-success">   
	               	<div class="panel-heading"><b>My Shortlists</b></div>
                                  ...
                                  if(jobs.length > 0){
                                    ...
                                    %>
                                      <tr>
                                        ...
                                        <td>
                                          <a class="btn btn-xs btn-info" href='viewShortList.html?comp_num=<%=jobs[i].getCompetitionNumber()%>'>View List</A>
                                        </td>
                                      </tr>
                                    <%}  
                                    }
