...
<%
  ...
  if(v_cal.get(Calendar.AM_PM) == Calendar.AM)
  	morning = true;
  
  if(!com.esdnl.util.StringUtils.isEmpty(request.getParameter("view_date")))
    v_cal.setTime(sdf.parse(request.getParameter("view_date")));
  ...
  if(morning){
    ...
    v_cal.set(Calendar.HOUR, 0);
    v_cal.set(Calendar.MINUTE, 0);
    v_cal.set(Calendar.AM_PM, Calendar.PM);
  }  
%>
                ...
                <tr>
                  ...
                  <td width="150" align="left" valign="middle">		
                    <table cellpadding="0" cellspacing="0">
                      <tr><td align="center" style="padding-bottom:5px;"><span class="displayWhiteDate14px">Book Employee</span></td></tr>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                        ...
                        <tr>
                          <td width="100%">
                            ...
                            <div style='border:solid 1px #FF0000; color:#ff0000;padding:3px;'>
                              <table cellpadding="0" cellspacing="0">
                                <tr>
                                  <td style="color:#ff0000;font-family:arial;font-weight:bold;font-size:10px;"><%=(String)request.getAttribute("msg")%></td>
                                </tr>
                              </table>
                            </div>
                            <br>
                      ...
                      <tr>
                        <td width="350" align="left" valign="top" style="padding-top:8px;">
                          <%if((emp != null)&&(request.getAttribute("msg") == null)){%>
                            <form name="book_emp_action" action="empBooked.html" method="POST">
                              <input type="hidden" name="op" value="EMP_BOOKED">
                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                ...
                                <tr style="height:18px;">
                                  ...
                                  <td valign="top" >
                                    <%
                                    	if(morning)
                                    		v_cal.add(Calendar.HOUR, 4);
                                    	else
                                    		v_cal.add(Calendar.HOUR, 3);
                                    %>
                                    <table align="left">
                                      <tr>
                                        <td>
