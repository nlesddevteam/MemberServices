	...
	<body>
		...
		<div class='main' style="max-width:650px;font-size:10px;">
			...
			<div class='content'>
				...
				<p>
					This letter is to confirm your appointment to a position with the Newfoundland and Labrador English School District.  The 
					specifics of your position are listed below.  The terms of your employment will be in keeping with the policies and by laws 
					of the District and/or the applicable Collective Agreement.  You should print a copy of this correspondence for future 
					references.  
				</p>
