...
<esd:SecurityRequiredPageObjectsCheck
	names='<%=new String[]{"REFERENCE_CHECK_REQUEST_BEAN", "JOB", "JOB_ASSIGNMENTS", "AD_REQUEST_BEAN", "PROFILE"}%>'
...
<div class="pageHeader">Teacher Candidate <%= profile.getFullNameReverse() %> Reference</div>
 ...
 <form action="addNLESDExternalTeacherReference.html" method="POST" name="admin_nlesd_rec_form" id="admin_nlesd_rec_form">
									...
									<div class="table-responsive"> 
										    ...
										    <tbody>
											    ...
											    <tr>
												    ...
												    <td class="tableResult" style="text-transform:Capitalize;"><%=refReq.getCheckRequester().getFullName() %></td>
											    </tr>
											    <tr>
												    <td class="tableTitle">PROVIDING REFERENCE:</td>
												    <td class="tableResult" style="text-transform:Capitalize;">
												    <input placeholder="Name of Person Providing Reference?" type="text" name="ref_provider_name" id="ref_provider_name" class="form-control">
												    </td>
											    </tr>
											    <tr style="border-bottom:1px solid silver;">
												    <td class="tableTitle">POSITION:</td>
												    <td class="tableResult">
												    <input type="text" name="ref_provider_position" id="ref_provider_position" class="form-control" placeholder="Enter Job Title/Position of Above person providing this reference." maxlength="130">
												   	</td>
											    </tr>
										    </tbody>
									    </table>
...
<div class="panel panel-success">
  <div class="panel-heading">Domain 1: Planning and Preparation</div>
  	...
  	<div class="alert alert-danger" id="section2Error" style="display:none;">ERROR: Please make sure you rate each statement below.</div>	
									<div class="table-responsive">														
					<%if(refscale.equals("3") || refscale.equals("5")){%>
