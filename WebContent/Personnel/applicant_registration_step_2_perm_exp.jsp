...
<body><div style="float:right;margin-top:-10px;font-size:72px;color:rgb(0, 128, 0,0.2);font-weight:bold;vertical-align:top;">2b</div>
<div style="font-size:20px;padding-top:10px;color:rgb(0, 128, 0,0.8);font-weight:bold;text-align:left;">
SECTION 2b: Editing your Teacher/Educator HR Application Profile 
</div>
...
<div class="panel-group" style="padding-top:5px;">                               
	               	...
	               	<div class="panel-heading"><b>2b. NLESD PERMANENT EXPERIENCE</b></div>
      			 	<div class="panel-body"> 
					<div class="table-responsive"> 

					<form id="AddPermExpForm" name="AddPermExpForm" action="applicantRegistration.html?step=2A" method="post">
                               ...
                               <!-- <input type="button" value="Save" class="btn btn-sm btn-success" onclick="document.location.href='applicant_registration_step_2_perm_exp.jsp'">-->
                               </div>
                                  
                                <br/>   
                               <!-- List Current Experience, if any. If not, do not show (Built into the class) -->
                               <job:ApplicantNLESDPermanentExperience/>  
