	...
	%>	
  	...
  	(<%=totalScore %> out of a possible <%=totalRates%>).</div>
	...
	<div class="table-responsive">
				...
				<tr><td class="tableTitle">Person providing email:</td><td class="tableResult"><%= ref.getProviderEmail() %></td></tr>
		      			 	       		...
		      			 	       		<table class="table table-striped table-condensed" style="font-size:12px;padding-top:3px;border-top:1px solid silver;">							   
											    ...
											    <thead>
												 ...
												 <tbody>
												     <tr>
													    <td>Q1.</td>
													    <td>Did the candidate ask permission to use your name as a reference?<br/>
													    <span class="tableAnswer"><%=ref.getQ1() %></span>
													    </td>
													 </tr>
													 <tr>
													    <td>Q2.</td>
													    <td>How long have you known this candidate in a professional capacity?<br/>
													    <span class="tableAnswer"><%=ref.getQ2() %></span>
													    </td>
													    
													 </tr> 
													 <tr>
													    <td>Q3.</td>
													    <td>In what capacity are you able to assess the performance of this applicant?<br/>
													     <span class="tableAnswer"><%=ref.getQ3() %></span>
													    </td>													    
													 </tr> 
...
<div class="panel panel-success">
  <div class="panel-heading">Ratings</div>
  	<div class="panel-body">
  	<%if(isadmin.equals("Y")){%>
  	<div class="alert alert-info" style="text-align:center;">Total Score out of 70: <%=ref.getTotalScore()%></div>
	<%} %>	
									<div class="table-responsive">
									
										The following has been rated from a scale of <%=val1%> to <%=val6%>.  
												 ...
												 <tbody>
													...
													<tr>
													 ...
													 <tr>
													    ...
													    <td>
													    <span class="tableAnswer"><%= ref.getScale11()%></span>
														</td>
													 </tr>					
													 <tr>
													    <td>12.</td>
													 ...
													 <tr style="display:none;">
													    ...
													    <td>
													   <span class="tableAnswer"><%= ref.getScale13()%></span>
														</td>
													 </tr>						
													 <tr>
													    <td>14.</td>
													    ...
													    <td>
													    <span class="tableAnswer"><%= ref.getScale14()%></span>
														</td>
													 </tr>								
													</tbody>
									    </table>
											    ...
											    <thead>
												 ...
												 <tbody>
												     <tr>
													    ...
													    <span class="tableAnswer"><%=ref.getQ4()== null ? "N/A" :ref.getQ4() %></span>
													   </td>
													 </tr>
												      <tr>
													   	<td>Q5.</td>
													    ...
													    <span class="tableAnswer"><%=ref.getQ5()== null ? "N/A" :ref.getQ5() %></span>
													    </td>
													 </tr>
												     <tr>
													   	<td>Q6.</td>
													    ...
													    <span class="tableAnswer"><%=ref.getQ6()== null ? "N/A" :ref.getQ6() %></span>
													    </td>
													 </tr>
												     <tr>
													   	<td>Q7.</td>
													 ...
													 <tr>
													   	<td>Q9.</td>
													    <td>
													    What was the applicant's reason for leaving you employ?<br/>
													    <span class="tableAnswer"><%=ref.getQ9()== null ? "N/A" :ref.getQ9() %></span>
													    </td>
													 </tr>
												      <tr>
													   	<td>Q10.</td>
													    <td>Would you hire/rehire the applicant? <br/>
													    <span class="tableAnswer"><%=ref.getQ10() ==null ? "N/A" :ref.getQ10() %></span>
													    </td>
													 </tr>
													 <tr>
													   	<td>Q11.</td>
													    <td>Overall, how would you rate the applicant's performance while employed with you?<br/>
													    <span class="tableAnswer"><%=ref.getQ11()== null ? "N/A" :ref.getQ11() %></span>			
													    </td>
													 </tr>
													 <tr>
													   	<td>Q12.</td>
													    <td>Other information that might be helpful in making a hiring decision?<br/>
													  <span class="tableAnswer"><%=ref.getQ12()== null ? "N/A" :ref.getQ12() %></span>
													  </td>
													 </tr>
												</tbody>
										</table>
