...
<body>
	...
	<c:choose>
		...
		<c:when test="${ppBlockSchools eq false}">
			<script>$("#ppStatus").css("display","block").addClass("alert-success").removeClass("alert-success").html("<b>WARNING:</b> Position Planner for School Administrators is currently ACTIVE.");</script>
		</c:when>
		<c:otherwise>
