...
<div class="panel-group" style="padding-top:5px;">                               
	               	...
	               	<div class="panel-heading"><b>My Job Shortlists</b></div>
      			 	<div class="panel-body">
      			 	Below is a list of positions sorted by Position Title.
      			 	  <br/><br/>
					<div class="table-responsive">
                                ...
                                %>
                                    ...
                                    for(int i=0; i < jobs.length; i++){
                                      jcnt++;
                                      if(
                                    		  (jobs[i].getJobType().getValue() != JobTypeConstant.ADMINISTRATIVE.getValue())
                                    ...
                                    %>
                                      <tr>
                                        ...
                                        <td>
                                          <a class="btn btn-xs btn-primary" href='viewJobShortList.html?comp_num=<%=jobs[i].getCompetitionNumber()%>'>View List</a>
                                        </td>
                                      </tr>
                                    <%}}%>
                                    </tbody>
