...
<form id="frmPostJob" action="applicantRegistration.html?step=10" method="post" enctype="multipart/form-data" style='padding:0;margin:0;'>
					...
					<div class="panel-group">
								    <div class="panel panel-info">
								      ...
								      <br/><b>Notice:</b>  For <b>Code of Ethics and Conduct Declaration</b>, make sure you select the proper doc type as there are two Code of Conduct types to choose from. 
								      The <b>Code of Conduct</b> is what you request from the RCMP or RNC. The Code of Ethics and Conduct is the staff training module.
