...
<%NLESDReferenceSSSupportBean ref = (NLESDReferenceSSSupportBean) request.getAttribute("mref");%>
...
<span style="font-size:11px;">
			                   ...
			                   <table class="table table-striped table-condensed" style="font-size:10px;">							   
								...
								<table class="table table-striped table-condensed" style="font-size:10px;padding-top:3px;border-top:1px solid silver;">		
												...
												<table class="table table-striped table-condensed" style="font-size:10px;">							   
										   								<thead>
																		<tr>
																			<td width="40%">Personal Factors</td>
																			<td width="10%">Excellent</td>
																			<td width="10%">Good</td>
																			<td width="10%">Average</td>
																			<td width="10%">Needs<br/>Improvement</td>
																			<td width="10%">Unacceptable</td>
																			<td width="10%">N/A</td>
																		</tr>
																		</thead>
																		<tbody>
																		<tr>
																			<td>1. Displays positive attitude towards job</td>
																		...
																		<tr>
																			<td>2. Ability to get along with people (peers and management)</td>
																		...
																		<tr>
																			<td>3. Flexibility/adjustment to new situations</td>
																		...
																		<tr>
																			<td>4. Organizational and time management</td>
																		...
																		<tr>
																			<td>5. Verbal and written communications skills</td>
																		...
																		<tr>
																			<td>6. Computer knowledge and skills</td>
																		...
																		<tr>
																			<td>7. Ability to handle stressful situations</td>
																		...
																		<tr>
																			<td>8. Dependability (punctuality and attendance)</td>
																		...
																		<tr>
																			<td>9. Ability to work independently with minimum supervision</td>
																		...
																		<tr>
																			<td>10. Open to constructive criticism and advice</td>
																		...
																		<tr>
																			<td>11. Displays courtesy and tact</td>
																		...
																		<tr>
																			<td>12. Level of professionalism</td>
																		...
																		<tr>
																			<td>13. Personal appearance and hygiene</td>
																		...
																		<tr>
																			<td>14. Indvidual's performance compared to others with similar duties</td>
						...
						<table class="table table-striped table-condensed" style="font-size:10px;">							   
												...
												<tbody>	
											   	<tr>
												<td width="100%">Please give a brief description of the applicant's duties while in your employ.</td>
												</tr>
												<tr>
