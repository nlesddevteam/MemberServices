         	...
         	<c:if test="${ msgERR ne null }">  
          		<div class="alert alert-danger" style="margin-top:10px;margin-bottom:10px;padding:5px;"><b>ERROR:</b> ${ msgERR } </div>     
					...
					<esd:SecurityAccessRequired permissions="PERSONNEL-ADMIN-VIEW">
						...
						<p class='text-danger'>
							<b>Important:</b> The "<span class='text-info' style='font-weight: bold;'>blue</span>" numbers in the tables below are CLICKABLE LINKS to a page listing the competitions used to calculate the statistic. 
						</p>
							...
							<table class="table table-sm table-bordered" style="font-size:11px;width:100%;background-color:White;">								
									...
									%>
										...
										<%} %>												
											...
											<td class="regionRow<%=rowCnt%>"><a href="listVacanciesWithRecommendationRejected.html?sy=<%= statsSchoolYear %>&zid=<%= entry.getKey().getZoneId() %>"><%= entry.getValue().getTotalRecommendationRejected() %></a></td>
								...
								<table class="table table-sm table-bordered" style="width:100%;max-width:600px;font-size:11px;width:100%;background-color:White;">									
									<tbody>
										<tr>
									     ...
									     <tr>
											<td scope="row" style='text-align:center;font-size:18;color:Navy;'><a href="listVacanciesWithOffersQueued.html"><%= stats.getOffersQueued() %></a></td>
											<td style='text-align:center;font-size:18;color:Green;'><a href="listVacanciesWithOffersInprogress.html"><%= stats.getOffersInProgress() %></a></td>
											<td style='text-align:center;font-size:18;color:Red;'><a href="listVacanciesWithOffersExpired.html"><%= stats.getOffersExpired() %></a></td>
										</tr>
									</tbody>
								</table>
