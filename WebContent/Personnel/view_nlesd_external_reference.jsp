...
<%
	NLESDReferenceExternalBean ref = (NLESDReferenceExternalBean) request.getAttribute("REFERENCE_BEAN");
...
<body>
	...
	<div class="panel panel-success">
		<div class="panel-heading">
			External Candidate Reference Check for <b><%=profile.getFullNameReverse()%>.</b>
		</div>
	...
	<div class="panel panel-success">
		...
		<div class="panel-body">
			...
			<div class="alert alert-danger" id="section1Error"
				style="display: none;">Please make sure ALL questions below
				are answered.</div>
			<div class="table-responsive">
				<table class="table table-striped table-condensed"
					...
					<tbody>
						...
						<tr>
							<td>Q2.</td>
							<td>How long have you known this candidate in a professional
								capacity? <br />
						...
						<tr>
							<td>Q3.</td>
							<td>In what capcity are you able to assess the performance
								of this candidate? <br />
							<span class="tableAnswer"><%=ref.getQ3()%></span>
							</td>
						</tr>
						<tr>
							<td>Q4.</td>
							<td>In which subjects/classes have you observed the
								candidate's performance? <br />
							<span class="tableAnswer"><%=ref.getQ4()%></span>
							</td>
						</tr>
					</tbody>
				</table>
	...
	<div class="panel panel-success">
		...
		<div class="panel-body">
			...
			<div class="table-responsive">
				The following has been rated from a scale of
				<%=val1%>
				to
				<%=val4%>. (<%=val4%>-Proficient,
				<%=val3%>-Competent,
				...
				<table class="table table-striped table-condensed"
					...
					<tbody>
						...
						<tr>
							<td>&nbsp;</td>
							<td colspan=2>Comments:<br /> <span class="tableAnswer"><%=(!StringUtils.isEmpty(ref.getDomain1Comments()) ? ref.getDomain1Comments() : "none")%></span>
							</td>
						</tr>
					</tbody>
				</table>
			...
			<div class="table-responsive">
				...
				<table class="table table-striped table-condensed"
					...
					<tbody>
						...
						<tr>
							<td>&nbsp;</td>
							<td colspan=2>Comments:<br /> <span class="tableAnswer">
			...
			<div class="table-responsive">
				...
				<table class="table table-striped table-condensed"
					...
					<tbody>
						...
						<tr>
							<td>&nbsp;</td>
							<td colspan=2>Comments:<br /> <span class="tableAnswer"><%=(!StringUtils.isEmpty(ref.getDomain3Comments()) ? ref.getDomain3Comments() : "none")%></span>
							</td>
						</tr>
					</tbody>
				</table>
			...
			<div class="table-responsive">
				...
				<table class="table table-striped table-condensed"
					...
					<tbody>
						...
						<tr>
							<td>&nbsp;</td>
							<td colspan=2>Comments:<br /> <span class="tableAnswer"><%=(!StringUtils.isEmpty(ref.getDomain4Comments()) ? ref.getDomain4Comments() : "none")%></span>
							</td>
						</tr>
					</tbody>
				</table>
