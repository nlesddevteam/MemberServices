...
<!-- CRIMINAL OFFENCE DECLARATIONS ----------------------------------------------------------------------------------------->               
  ...
  <div class="panel-group" style="padding-top:5px;">                               
	               	...
	               	<div class="panel-heading"><b>SUBSTITUTE PREFERENCES</b> <span class="no-print" style="float:right;padding-right:5px"><a class="btn btn-xs btn-primary" href="applicant_registration_step_10.jsp">EDIT</a></span></div>
      			 	<div class="panel-body"> 
					<div class="table-responsive"> 
