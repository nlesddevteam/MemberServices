  ...
  <div class="panel-group" style="padding-top:5px;">                               
                    ...
                    <div align="center" style="width:100%;text-align:center;padding-bottom:10px;">
                     ...
                     <div style="clear:both;">&nbsp;</div>        
                    			 ...
                    			 <table id='applicant-list' class="jobsappListing table table-condensed" style="font-size:12px;background-color:#FFFFFF;margin-top:10px;">
								    <thead>
								      <tr style="border-top:1px solid black;">
								        <th width='25%'>NAME (Last, First)</th>								        
								   ...
								   <%if(applicants.length > 0){
                                    ...
                                    <c:set var="staleProfile" value="<%=applicants[i].isStale() %>"/>
                                      ...
                                      <td><%= applicants[i].getProfileType().equals("S") ? "Support": "Teaching" %></td>                                                                        
