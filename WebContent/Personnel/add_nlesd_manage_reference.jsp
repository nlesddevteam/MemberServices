...
<html>
		...
		<script>
			$('document').ready(function(){
				...
				$('#applicant_list').change(function(){
					$.post('addNLESDManageReference.html?op=CANDIDATE_DETAILS',
						{
			...
			function search_applicants(){
				...
				$.post('addNLESDManageReference.html?op=APPLICANT_FILTER',
					{
	...
	<div class="pageHeader">Candidate Reference (Management)</div>
