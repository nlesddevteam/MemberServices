...
-->
  <table width="760" cellpadding="0" cellspacing="0" border="0" style="border:solid 1px #0A218C;" align="center">
    <tr>
      <td>   
        <jsp:include page="../includes/top_nav.jsp" flush="true">
          <jsp:param name="activeTab" value='<%=TabConstants.TAB_TEACHERS%>'/>
        </jsp:include>
                    ...
                    <table width="540" cellpadding="0" cellspacing="0" border="0" style="border-style: solid; border-color: #EBEBEB; border-width: 1px;">
                      <tr>
                        <td width="120" height="24" align="left" valin="middle" style="background-color: #EBEBEB;">
                          <img src="/MemberServices/Personnel/v2.0/images/spacer.gif" width="3" height="1"><span class="displayBoxTitle">Welcome</span>
                        </td>
                      ...
                      <tr>
                        <td colspan="2" style="padding:5px;">
                          ...
                          <table width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                              <td width="100%"><img src="../images/spacer.gif" height="300"></td>
                            </tr>
                          </table>
                          <!-- CONTENT ENDS HERE -->
                        </td>
    ...
    <tr>
      <td style="border-top:solid 1px #0A218C;">
