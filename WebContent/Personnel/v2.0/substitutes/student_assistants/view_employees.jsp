                    ...
                    <table width="540" cellpadding="0" cellspacing="0" border="0" class="box">
                      <tr class="header">
                        <td width="240" height="24" align="left" valign="middle" class="title">
                          <img src="/MemberServices/Personnel/v2.0/images/spacer.gif" width="3" height="1"><span class="displayBoxTitle">Tasks &gt; Employee List</span>
                        </td>
                      ...
                      <tr>
                        <td colspan="2" style="padding:10px;" class="content">
                          ...
                          <table width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                              <td width="100%" class="subtitle">Employee List</td>
                            </tr>
                            <tr>
                              <td width="100%" align="center" style="padding-top:5px;">
                                <%for(int i=0; i < 26; i++){%>
                                  <%if(!Character.toString((char)(65+i)).equals(group)){%>
                                    <a href="view_employees.jsp?group=<%=(char)(65+i)%>" class="letterLink"><%=(char)(65+i)%></a>
                                  <%}else{%>
                                    <span style="color:#FF0000;"><%=(char)(65+i)%></span>
                                  <%}%>
                                <%}%>
                              </td>
                            </tr>
