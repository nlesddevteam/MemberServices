                    ...
                    <table width="540" cellpadding="0" cellspacing="0" border="0" class="box">
                      <tr class="header">
                        <td width="240" height="24" align="left" valign="middle" class="title">
                          <img src="/MemberServices/Personnel/v2.0/images/spacer.gif" width="3" height="1"><span class="displayBoxTitle">Tasks &gt; Availability List</span>
                        </td>
                      ...
                      <tr>
                        <td colspan="2" style="padding:10px;" class="content">
                          ...
                          <table width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                              <td width="100%" class="subtitle"><%=LocationConstant.SUBSTITUTE_EASTERN_REGION%> Availability List</td>
                            </tr>
