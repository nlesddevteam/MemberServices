...
-->
  <table width="760" cellpadding="0" cellspacing="0" border="0" style="border:solid 1px #00833B;" align="center">
    <tr>
      <td>   
        <jsp:include page="../includes/top_nav.jsp" flush="true">
          <jsp:param name="activeTab" value='<%=TabConstants.TAB_STAFF%>'/>
        </jsp:include>
    ...
    <tr>
      <td style="border-top:solid 1px #00833B;">
