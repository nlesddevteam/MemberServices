...
<%
  ...
  AwardTypeBean[] types = (AwardTypeBean[]) request.getAttribute("AWARD_TYPES");
%>
                    ...
                    <table width="540" cellpadding="0" cellspacing="0" border="0" class="box">
                      <tr class="header">
                        <td width="240" height="24" align="left" valin="middle" class="title">
                          <img src="/MemberServices/Personnel/v2.0/images/spacer.gif" width="3" height="1"><span class="displayBoxTitle" >Recognition Request > Award Types</span>
                        </td>
                      ...
                      <tr>
                        <td colspan="2" class="content">
                          ...
                          <table width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                              <td width="100%" class="subtitle">Category: <%=cat.getCategoryName()%></td>
                            </tr>
                            ...
                            <tr style="padding-top:5px;">
                              <td width="100%">
                                  <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                      <td colspan="2">
                                        <form id="addTypeForm" action="addAwardType.html">
                                          ...
                                          <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border:solid 1px #c4c4c4;">
                                            <tr>
                                              <td colspan="3" class="subtitle"  style="color:#FF6600;">Add Award</td>
                                            </tr>
                                            <tr style="padding-top:5px;padding-bottom:5px;background-color:#e0e0e0;">
                                              <td width="20%" class="Label">Award Name:</td>
                                              <td width="60%" align="left"><input type="text" id="type_name" name="type_name" value="" class="requiredInputBox" style="width:255px;"></td>
                                    ...
                                    <tr>
                                      <td width="50%" class="Label">Award Type</td>
                                      <td width="*" align="right">&nbsp;</td>
                                    </tr>
                                    <%if((types != null)&&(types.length > 0)){%>
                                      <%for(int i=0; i < types.length; i++){%>
                                        <tr style="padding-top:5px;background-color:<%=((i%2)!=0)?"#e0e0e0":"#FFFFFF"%>">
                                          <td width="50%" class="content"><%=types[i].getAwardName()%></td>
                                          <td width="*" align="right" style="padding-right:3px;">&nbsp;</td>
                                        </tr>
                                      <%}%>
                                    <%}else{%>
                                      <tr style="padding-top:5px;background-color:#FFFFFF;">
                                          <td colspan="2" class="content">No award types on record.</td>
                                      </tr>
                                    <%}%>
                                  </table>
