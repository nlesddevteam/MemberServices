                                ...
                                <form name="requestActionForm" id="requestActionForm" action="requestAction.html">
                                  ...
                                  <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                      ...
                                      <td width="*" align="left" class="content"><%=req.getName()%></td>
                                    </tr>
                                    ...
                                    <tr style="padding-top:2px;">
                                      <td colspan="2" class="content" valign="top"><%=req.getText()%></td>
                                    </tr>
                                    <tr style="padding-top:5px;">
                                      <td colspan="2" class="content" valign="top" align="right" style="padding-right:3px;">
                                        <input type="button" value="edit" onclick="document.location.href='editTemplate.html?id=<%=req.getId()%>';">
                                      </td>
                                    </tr>
                                  </table>
                                </form>
