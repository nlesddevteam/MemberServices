...
<script>
  ...
  <div class="panel-heading">Competition # <%=job.getCompetitionNumber()%> Filter</div>
  	...
  	To filter out applicants for this competition, select the criteria below. <br/><br/>
	                          <form action="filterJobApplicants.html" method="post">
	                              ...
	                              <div class="input-group">
								    <span class="input-group-addon">[TLA] 20 or more courses completed and/or CEC L2?</span>
								    <div class="form-control">        
