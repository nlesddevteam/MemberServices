							...
							<table id="groupsApproval" class="table table-condensed table-striped" style="font-size:12px;background-color:#FFFFFF;">								
								...
								<c:forEach items='${ areas }' var='area'>
                    					<tr id="div${area.teacherAreaId}"> 
											...
											<td>
												<a href="#" class="btn btn-success btn-xs" style="color:white;" onclick="openapprovedialog('${area.teacherAreaId}','${area.teacherName}','${area.areaDescription}','A')">APPROVE</a>
												<a href="#" class="btn btn-danger btn-xs" style="color:white;" onclick="openapprovedialog('${area.teacherAreaId}','${area.teacherName}','${area.areaDescription}','D')">DECLINE</a>
											</td>   
										</tr>
								</c:forEach> 
								</tbody>
