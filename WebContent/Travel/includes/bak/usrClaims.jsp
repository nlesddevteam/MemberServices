...
int yearLimit = 0;
int preClaims = 0;
String[] topPDClaims = new String[200];
String[] topClaims = new String[200]; 
int [] topPDAmounts = new int[200]; 
int[] topAmounts = new int[200]; 
int claimCounter = 0;
int counter1 = 0;
int counter2 = 0;
int counter3 = 0;
...
%>
   ...
   <script src="includes/js/Chart.min.js"></script>
        	  ...
        	  <% 
              	...
              	while(y_iter.hasNext())
              	{
                	...
                	<tr id="claimsrow" valign="top">
		             ...
		             // topClaims[cnt_month] = Utils.getMonthString(claim.getFiscalMonth()) + " " +  Utils.getYear(claim.getFiscalMonth(), claim.getFiscalYear());
		              //topAmounts[cnt_month] = (int)claim.getSummaryTotals().getSummaryTotal();
                     claimCounter++;
                    	//}
    		  	...
    		  	while(y_iter.hasNext())
              	{
                    ...
                    <tr id="claimsrow" valign="top">
		              ...
		              <%=sdf_title.format(((PDTravelClaim)claim).getPD().getStartDate())%>
                    			...
                    			<td> 
                    			<b><%= ((PDTravelClaim)claim).getPD().getTitle()  %></b><br/><%=((PDTravelClaim)claim).getPD().getDescription().replace("'","") %>                   			
	...
	<% if(counter1 > 0) { %>
	<div class="alert alert-danger"><b>NOTICE:</b> Any claims that are in Pre-Submission Status (prior to July 2016) and have NOT been submitted for processing, have now EXPIRED and will not be paid.</div>
