...
<html>
	<head>
		<title>Save Claim Changes</title>
    ...
    <form name="save_claim_changes_form">
      ...
      <table width="100%" height="100%" cellpadding="0" cellspacing="0" style="border:solid 1px #005100;">
        <tr>
          <td id="form_header" width="100%" height="75">
            <img src="images/save_claim_header.jpg"><br>
          </td>
        </tr>
        <tr>
                  ...
                  <table width="100%" cellpadding="0" cellspacing="6" border="0">
                    ...
                    <tr style="padding-top:10px;">
                      <td colspan="2" align="center" style="padding-right:5px;">
                        Are you sure you want to SAVE CHANGES to this claim?
                      </td>
                    </tr>
                  </table>
                </td>
                    ...
                    <tr>
                      ...
                      <td width="15%" align="right" valign="middle">
                        <img src="images/btn_yes_01.gif"
                          ...
                          onclick="savetravelclaimchanges();"><br>
                      </td>
