<!-- NLESD.CA CHOOL REVIEW DECORATOR FILE (C) 2020  -->	
...
<!-- META TAGS  -->			
    	...
    	<meta name="generator" content="Eclipse IDE for Enterprise Java Developers.Version: 2020-06 (4.16.0)">
	    <meta name="dcterms.created" content="Mon, 1 Sept 2020 16:59:07 GMT">    	     				
		...
		<title><decorator:title default="School Review System" /></title>
...
<!-- CSS STYLESHEET FILES CDN -->
 ...
 <!--  CSS LOCAL FILES - ANY MODIFICATIONS DO HERE-->  		
  		<link rel="stylesheet" href="includes/css/sr.css?ver=${todayVer}"/>				
