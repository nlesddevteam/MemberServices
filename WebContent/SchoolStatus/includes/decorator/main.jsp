...
<!-- CSS STYLESHEET FILES CDN -->
 ...
 <!--  CSS LOCAL FILES - ANY MODIFICATIONS DO HERE-->  		
  		<link rel="stylesheet" href="/MemberServices/SchoolStatus/includes/css/admin.css?ver=${todayVer}"/>				
...
<!-- JAVASCRIPT FILES LOCAL- ANY MODIFICATIONS DO HERE-->			
		...
		<script src="/MemberServices/SchoolStatus/includes/js/admin.js?ver=${todayVer}"></script>	
	...
	<div id="loadingSpinner" style="display:none;z-index:99999;"><div id="spinner"><img src="/MemberServices/SchoolStatus/includes/img/loading4.gif" width="150" border=0><br/>Loading data, please wait...</div></div>
	

	<!-- PAGE BODY -->	
			<div class="mainContainer">
				<div class="container-fluid">	
				 <img src="/MemberServices/SchoolStatus/includes/img/header-admin.png" style="width:100%;"/>
...
<script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
		  ...
		  <div class="copyright">School Status System 2.0 &copy; 2021 NLESD &middot; All Rights Reserved.</div>		
