<!-- NLESD.CA BUS ROUTE ADMINISTRATION (C) 2021  -->	
...
<!-- META TAGS  -->			
		...
		<title><decorator:title default="Bus Route Directory" /></title>
...
<!-- CSS STYLESHEET FILES CDN -->
 ...
 <!--  CSS LOCAL FILES - ANY MODIFICATIONS DO HERE-->  		
  		<link rel="stylesheet" href="/MemberServices/BusRoutes/includes/css/busroutes.css?ver=${todayVer}"/>				
...
<!-- JAVASCRIPT FILES LOCAL- ANY MODIFICATIONS DO HERE-->			
		...
		<script src="/MemberServices/BusRoutes/includes/js/busroutes.js?ver=${todayVer}"></script>	
	...
	<div id="loadingSpinner" style="display:none;z-index:99999;"><div id="spinner"><img src="/MemberServices/BusRoutes/includes/img/loading4.gif" width="150" border=0><br/>Loading data, please wait...</div></div>
	

	<!-- PAGE BODY -->	
			<div class="mainContainer">
				<div class="container-fluid">	
				 <img src="/MemberServices/BusRoutes/includes/img/header.png" style="width:100%;"/>
...
<script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
		  ...
		  <div class="copyright">Bus Route Posting System 2.1 &copy; 2021 NLESD &middot; All Rights Reserved.</div>		
