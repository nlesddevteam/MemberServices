...
<div class="siteHeaderRed">Archived Closed Tenders ( ${todayYear - 1} and previous ) (<span class="archivedClosedCount"></span>)</div>
  
Below is a list of currently ARCHIVED Closed tenders sorted by date (newest) and tender number (highest). 
...
<c:if test="${((g.tenderStatus.description eq 'ARCHIVED') or (g.tenderStatus.description eq 'CLOSED')) and (yearClosed lt todayYear)}">
