...
<div class="siteHeaderRed">Archived Cancelled Tenders ( ${todayYear - 1} and previous ) (<span class="archivedCancelledCount"></span>)</div>
  
Below is a list of currently ARCHIVED Cancelled tenders sorted by date (newest) and tender number (highest). 
...
<c:if test="${((g.tenderStatus.description eq 'ARCHIVED') or (g.tenderStatus.description eq 'CANCELLED')) and (yearClosed lt todayYear)}">
