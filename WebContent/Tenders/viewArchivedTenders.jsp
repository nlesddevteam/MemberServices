...
<div class="siteHeaderGreen">Archived Tenders ( ${todayYear - 1} and previous ) (<span class="archivedClosedCount"></span>)</div>
  
Below is a list of currently ARCHIVED tenders sorted by date (newest) and tender number (highest). 
 ...
 <esd:SecurityAccessRequired permissions="TENDER-VIEW">
	...
	<div align="center">
																...
																<esd:SecurityAccessRequired permissions="TENDER-ADMIN,TENDER-EDIT,TENDER-VIEW">  
												                      	<a class="btn btn-sm btn-primary" style="color:white;margin-top:5px;" role="button" href="viewTenders.html">Current (${todayYear})</a> &nbsp;
												                      	<a class="btn btn-sm btn-danger" style="color:white;margin-top:5px;" role="button" href="viewClosedTenders.html">Closed (${todayYear})</a> &nbsp;
												                      	<a class="btn btn-sm btn-info" style="color:white;margin-top:5px;" role="button" href="viewAwardedTenders.html">Awarded (${todayYear})</a> &nbsp;
												                      	<a class="btn btn-sm btn-danger" style="color:white;margin-top:5px;" role="button" href="viewCancelledTenders.html">Cancelled (${todayYear})</a> &nbsp;
												                      	<a class="btn btn-sm btn-secondary" style="color:white;margin-top:5px;" role="button" href="viewArchivedTenders.html">Archived (${todayYear - 1} and previous)</a> &nbsp;
												                      	<a class="btn btn-sm btn-secondary" style="color:white;margin-top:5px;" role="button" href="viewUnsetTenders.html">Unset (${todayYear - 1} and previous)</a> &nbsp;
...
<c:if test="${((g.tenderStatus.description eq 'ARCHIVED') or (g.tenderStatus.description eq 'CLOSED')  or (g.tenderStatus.description eq 'AWARDED') or (g.tenderStatus.description eq 'CANCELLED')) and (yearClosed lt todayYear)}">
									...
									<c:set var="openRegionColor" value="region1"/>
                                  		...
                                  		<tr zone='${ contact.zone.zoneId }'>
													...
													<td class='${statusColor}' style="vertical-align:top;border-bottom:1px solid black;">												
															<c:choose>
															<c:when test="${g.tenderStatus.description eq 'AWARDED'}">
															<span style="color:white;background-color:Green;width:100%;font-weight:bold;">&nbsp; AWARDED &nbsp;</span>
															</c:when>
															<c:otherwise>
