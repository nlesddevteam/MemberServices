...
<div class="siteHeaderGreen">Awarded Tenders for ${todayYear} (<span class="awardedThisYearCount"></span>)</div>
  
Below is a list of currently AWARDED tenders sorted by closed date and tender number that have their status updated as Awarded and details entered. You can sort by clicking on the column header or search using the search tool below right. 
							...
							<c:otherwise>
									<c:set var="openRegionColor" value="region1"/>
                                  		...
                                  		<tr zone='${ contact.zone.zoneId }'>
													...
													<span style="color:white;background-color:Green;width:100%;font-weight:bold;">&nbsp;<i class="fas fa-check"></i>&nbsp;${g.tenderStatus.description}&nbsp;</span>
													</td>
