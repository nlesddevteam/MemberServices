...
<c:if test="${(g.tenderStatus.description eq 'EXCEPTIONS') and (yearClosed le todayYear)}">
							...
							<c:otherwise>
									<c:set var="openRegionColor" value="region1"/>
                                  		...
                                  		<tr zone='${ contact.zone.zoneId }'>
													...
													<span style="color:white;background-color:#8A2BE2;width:100%;font-weight:bold;">&nbsp;<i class="fas fa-exclamation-triangle"></i>&nbsp;EXCEPTION&nbsp;</span>
...
<tr>
<td></td>
<td>No Exception Tenders Found.</td>
<td></td>
<td></td>
<td></td>
<td></td>
