...
<div class="siteHeaderGreen">Archived Awarded Tenders ( ${todayYear - 1} and previous ) (<span class="archivedAwardedCount"></span>)</div>
  
Below is a list of currently ARCHIVED Awarded tenders sorted by date (newest) and tender number (highest). 
...
<c:if test="${((g.tenderStatus.description eq 'ARCHIVED') or (g.tenderStatus.description eq 'AWARDED')) and (yearClosed lt todayYear)}">
