...
<div class="registerEventDisplay" style="padding-top:50px;font-size:12px;">
...
<div class="alert alert-danger no-print topAlert" align="center" style="font-size:12px;display:none;"><b>*** EVENT ATTENDENCE NOTICE ***</b><br/>It is manditory that you confirm attendance to any event you hold. Please confirm below anyone registered who has attended the event. If someone attended who was not registered or listed below, please add using the 'Missing a Participant' link below and confirm.</div>         


	<div style="font-size:14px;font-weight:bold;width:100%;background-color:<%=bgcolor%>;color:<%=txtcolor%>">&nbsp;<%=regionName%> EVENT</div>
					
    <table class="table table-striped table-condensed" style="font-size:11px;padding-top:3px;">							   
