<%@ page language="java" isErrorPage="true" import="java.lang.*" isThreadSafe="false"%>
...
<title>
Newfoundland &amp; Labrador English School District - Event Calendar Error Notification
</title>
</head>
    ...
    <table width="400" cellpadding="1" cellspacing="2" border="0">
      <tr>
        ...
        <td width="300" valign="top" bgcolor="#FFFFFF">
          <font color="#FF0000"><b><%=e.toString()%><BR>Please refresh your calendar view.</b></font>
        </td>
      </tr>
    </table>
    <table width="400" cellpadding="1" cellspacing="2" border="0">
