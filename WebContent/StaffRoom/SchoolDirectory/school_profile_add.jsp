...
<esd:SecurityCheck permissions='WEBMAINTENANCE-SCHOOLPROFILE-ADMIN' />
<html>
...
<form action='updateSchool.html' method='POST' ENCTYPE="multipart/form-data" class="was-validated">
	             ...
	             You are adding a new school.  When you have your changes made, press <b>Save Changes</b> at the bottom of this page.
...
<div class="card bg-primary">
						  	<div class="card-header" style="font-weight:bold;color:White;font-size:16px;text-transform:uppercase;">1. DETAILS</div>
						  ...
						  Please provide a outside photo of your school. Current photo (if any) is shown below.<br/>
						  								<c:choose>
										              		<c:when test="${ school.details.schoolPhotoFilename ne null }">	                      		
							                      				<img src="https://www.nlesd.ca/schools/img/${ school.details.schoolPhotoFilename }" style="max-height:100px;float:right;padding:10px;">
							                    		...
							                    		<input type='file' class="form-control" name='schoolPhotoFile' />
														 ...
														 Current File: <a href="https://www.nlesd.ca/schools/img/${ school.details.schoolPhotoFilename }" target="_blank">${ school.details.schoolPhotoFilename }</a>
														 </c:if>
						...
						Please provide your school crest or logo. Current file (if any) is shown below.<br/>	              
	           											...
	           											<c:choose>
										              		<c:when test="${ school.details.schoolCrestFilename ne null }">										              				                      		
							                      				<img src="https://www.nlesd.ca/schools/img/${ school.details.schoolCrestFilename }" style="max-height:100px;float:right;padding:10px;">
							                      				<br/>To update file, <i>Choose File</i> below to select and upload. File <b>MUST BE</b> in JPG format. 
							                			...
							                			<div style="clear:both;"></div>
	           											 ...
	           											 Current File: <a href="https://www.nlesd.ca/schools/img/${ school.details.schoolCrestFilename }" target="_blank">${ school.details.schoolCrestFilename }</a>
														</c:if>
						</div></div>
