...
<form name="change" action="/MemberServices/MemberAdmin/Apps/Personnel/personnelAdminChange.html?update&pid=<%=p.getPersonnelID()%>" method="post">
            ...
            <table width="70%" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td width="100%" valign="top">
                  ...
                  <span class="header1">Personnel Profile Administration</span><BR>
                  <hr noshade color="#333333" size="2" width="100%" align="right">
                  <img src="/MemberServices/MemberAdmin/images/spacer.gif" width="1" height="10"><BR>
                  <table align="center" width="100%" cellpadding="5" cellspacing="0" border="0">
                    ...
                    <tr>
                      ...
                      <span class="title"><font style="font-weight:bold;">First Name</font></span>
                      </td>
                      <td>
	                      <input type="text" name='firstname' style="width:250px;" value="<%=p.getFirstName()%>" />
                      </td>
                    </tr>
                    <tr>
                      <td  width="30%" valign="middle" >
                      <span class="title"><font style="font-weight:bold;">Last Name</font></span>
                      </td>
                      <td>
	                      <input type="text" name='lastname' style="width:250px;" value="<%=p.getLastName()%>" />
                      </td>
                    </tr>
                    <tr>
                      <td  width="30%" valign="middle" >
                      <span class="title"><font style="font-weight:bold;">Username</font></span>
                      </td>
                      <td>
	                      <input type="text" name='username' style="width:250px;" value="<%=p.getUserName()%>" />
                      </td>
                    </tr>
                    <tr>
                      <td  width="30%" valign="middle" >
                      <span class="title"><font style="font-weight:bold;">Email</font></span>
                      </td>
                      <td>
	                      <input type="text" name='email' style="width:250px;" value="<%=p.getEmailAddress()%>" />
                      </td>
                    </tr>
                  </table>
                </td>
