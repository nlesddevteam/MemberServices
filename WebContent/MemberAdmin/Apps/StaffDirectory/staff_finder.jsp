                 ...
                 <div style='float:right;'>
                  ...
                  <table id='directoryList' align="center" width="100%" cellpadding="0" cellspacing="0" border="0" style="border:none;font-size:11px;">
                    ...
                    <c:if test="${fn:containsIgnoreCase(contact.division.name, param.division)}">  
                     ...
                     <c:choose>
                     <c:when test="${fn:containsIgnoreCase(contact.position, query) or fn:containsIgnoreCase(contact.fullName, query) or fn:containsIgnoreCase(contact.telephone, query)  or fn:containsIgnoreCase(contact.email, query)}">
                   ...
                   <c:if test="${ contains eq '0' }">No results found.</c:if>
				<c:if test="${ contains > '0' }">${contains} result(s) found.</c:if>
				<c:if test="${ contains > '20' }">Try narrowing your search criteria if you cannot find who you are looking for.</c:if>
				<br/><br/>	
                   
                   
                  
                     <p>
                     <div align="center"><a href="staff_directory.jsp"><img src="../includes/img/back-off.png" class="img-swap menuImage" title="Back to Directory"></a></div>
