...
<%}
  ...
  deleted = ((Boolean) request.getAttribute("deleted")).booleanValue();
%>
...
<html>
  ...
  <body topmargin="0" bottommargin="0" leftmargin="0" rightmargin="0" marginwidth="0" marginheight="0" background="images/bg.gif">
    <form name="permissions" action="deletePermission.html" method="post">
            ...
            <table width="75%" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td width="100%" valign="top">
                  ...
                  <span class="header1">Delete Permission</span><BR>
                  <hr noshade color="#333333" size="2" width="100%" align="right">
                  <img src="images/spacer.gif" width="1" height="10"><BR>
                  <table>
                    <tr>
              ...
              <tr>
                      <td align="right" colspan="2">
                        ...
                        <% if((request.getAttribute("msg") == null) || !deleted) { %>
                          <input type="hidden" name="uid" value="<%=p.getPermissionUID()%>">
                        ...
                        <% } else { %>
                          <img src="images/close_01.jpg" 
                            ...
                            onclick="refresh('DELETED'); self.close();">
                        <% } %>
                        <hr noshade color="#333333" size="1" width="100%" align="right">
                      </td>
                    </tr>
