                                ...
                                <form id="frmViewAgency" name="frmViewAgency" action="viewAgency.html" method="post">
                                  ...
                                  <fieldset>
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="padding:5px;">
                                      <tr>
                                        <td align="center">
                                          <nisep:StudentSchoolHistory />
                                        </td>
                                      </tr>
                                      <tr>
                                        <td align="left" bgcolor="#B8DB7C">
                                          <input style="font-size:10px;font-weight:bold;color: #EF9A48;" type="button" value="Add" onclick="document.forms[0].action='addStudentSchoolHistory.html';document.forms[0].submit();">
                                        </td>
                                      </tr>
                                    </table>
                                  </fieldset>
