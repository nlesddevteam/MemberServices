...
<tr>
<td width="80%" valign="top" align="left">
Search Repository is where you can find exam, unit test, and quiz questions that have been submitted by other teachers around the district.<BR><BR>
...
<tr>
<td width="80%" valign="top" align="left" colspan="2">
<span class="header2">Search By Question Type</span><BR>
</td>
</tr>
<tr>
<td width="80%" valign="top" align="left" bgcolor="#F5F5EF" colspan="2">
<select name="questionType"  multiple style="background-color:#FFFFFF; font-family: Arial, Helvetica, sans-serif; font-size: 11px;">
  <% iter = types.iterator();
     while(iter.hasNext())
     {
...
<tr>
<td width="80%" valign="top" align="left" colspan="2">
<span class="header2">Search By Question Subject</span><BR>
</td>
</tr>
<tr>
<td width="80%" valign="top" align="left" bgcolor="#F5F5EF" colspan="2">
...
%>  <tr id="crs-header">
      <td width="80%" valign="top" align="left" colspan="2">
        <span class="header2">Search By Question Course</span><BR>
      </td>
    </tr>
    <tr id="crs-footer">
      <td width="80%" valign="top" align="left" bgcolor="#F5F5EF" colspan="2">
