        ...
        <tr>
          <td>
                <img src="../images/nav_search_01.gif" border="0" alt="" style="cursor:hand;"
                  ...
                  onclick="window.location.href='searchEFileQuestions.html';"><br>
          </td>
          <td>  
               <img src="../images/nav_submit_question_01.gif" border="0" alt="" style="cursor:hand;"
                onMouseOut="src='../images/nav_submit_question_01.gif';"
                onMouseOver="src='../images/nav_submit_question_02.gif';"
                onclick="window.location.href='importExamQuestion.html';"><br>
          </td>
          <td>
