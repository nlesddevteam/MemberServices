        ...
        <td width="100%" valign="top">
          <center>
            <table width="80%" cellpadding="0" cellspacing="0" border="0">
              ...
              <tr>
                <td width="80%" valign="top" align="left">
                  Import Documents is where you will <a href="javascript:openWindow('import.jsp','import',150,150)" class="main"><b>import</b></a> your exams, assignments and lesson plans to E-File Repository.<BR><BR>
