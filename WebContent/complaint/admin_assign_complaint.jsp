                  ...
                  <td valign="top" width="100%">
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" valign="top">
                      ...
                      <tr>
                        <td valign="top" style="padding:5px;" width="100%">
                          <%if(complaint != null) {%>
                            <form method="POST" action="assignComplaint.html" name="theForm">
                              ...
                              <fieldset><legend><font style="color:#00407A;font-weight:bold;font-size:20px;FONT-FAMILY: T, 'Times New Roman', Times, serif;"><i>Assign Complaint</i></font></legend>
                                <table cellspacing="6" width="100%">
                                  <tr>
                                    <TD style="vertical-align: top;" width="150" align="right" style="font-weight:bold;">Complaint Handler:</TD>
                                    <TD width="*"><c:ComplaintHandlers id='assigned_id' cls='requiredInputBox' /></TD>
                                  </tr>
                                  <tr>
                                    <td colspan="2" align="center">
                                      <input type="submit" value="Assign" style="font-size:10px;">
                                    </td>
                                  </tr>
                                </table>
                              </fieldset>
