                  ...
                  <td valign="top" width="100%">
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" valign="top">
                      ...
                      <tr>
                        <td valign="top" style="padding:5px;" width="100%">
                          <%if(complaint != null) {%>
                            <form method="POST" action="addComplaintComment.html" name="theForm">
                              ...
                              <fieldset><legend><font style="color:#00407A;font-weight:bold;font-size:20px;FONT-FAMILY: T, 'Times New Roman', Times, serif;"><i>Add Comment</i></font></legend>
                                <table cellspacing="6" width="100%">
                                  <tr>
                                    <TD style="vertical-align: top;" width="100%"  style="font-weight:bold;">Comment:</TD>
                                  </tr>
                                  <tr>
                                    <TD width="100%"><textarea name="complaint_comment" class="requiredInputBox" rows="8" style="width:100%;"></textarea></TD>
                                  </tr>
                                  <tr>
                                    <td colspan="2" align="center">
                                      <input type="submit" value="Add Comment" style="font-size:10px;">
                                    </td>
                                  </tr>
                                </table>
                              </fieldset>
