...
<%
  ...
  ComplaintStatus status = (ComplaintStatus) request.getAttribute("COMPLAINT_NEW_STATUS");
%>
<html>
<head>
                  ...
                  <td valign="top" width="100%">
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" valign="top">
                      ...
                      <tr>
                        <td valign="top" style="padding:5px;" width="100%">
                          <%if(complaint != null) {%>
                            <form method="POST" action="changeComplaintStatus.html" name="theForm">
                              <input type="hidden" name="CONFIRM" value="true">
                              <input type="hidden" name="id" value="<%=complaint.getId()%>">
                              <input type="hidden" name="status" value="<%=status.getValue()%>">
                              ...
                              <fieldset><legend><font style="color:#00407A;font-weight:bold;font-size:20px;FONT-FAMILY: T, 'Times New Roman', Times, serif;"><i>Reject Complaint</i></font></legend>
                                <table cellspacing="6" width="100%">
                                  <tr>
                                    <TD style="vertical-align: top;" width="100%" align="center" style="font-weight:bold;">Are you sure you want to change the status of this complaint to <span style="color:#FF0000;"><%=status.getDescription()%></span>?</TD>
                                  </tr>
                                  <tr>
