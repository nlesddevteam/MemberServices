...
<html>
    ...
    <form id="board_meeting_minutes_frm" action="addMinutes.html" method="post" ENCTYPE="multipart/form-data">
              ...
              <tr>
                <td width="100%" align="center" valign="middle" style="background: url('images/body_bkg.gif') top left repeat-y;">
                  <table width="60%" cellpadding="0" cellspacing="0" align="center" valign="top">
                    ...
                    <tr>
                      <td width="125" align="left" valign="middle"><span class="requiredstar">*</span><span class="label">Meeting Date:</span></td>
                      <td width="*" align="left" valign="middle">
                        <table width="60" cellpadding="0" cellspacing="0" style="padding:0px;">
                            <tr style="height:18px;">
                              <td width="95%"><input  type="text" id="meeting_date" name="meeting_date" style="width:51px;" class="requiredinput_date" value="" readonly></td>
    ...
    <script language="JavaScript">
      var datepicker = new CalendarPopup(document.forms['board_meeting_minutes_frm'].elements['meeting_date']);
