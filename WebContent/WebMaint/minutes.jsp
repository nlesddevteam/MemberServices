...
<%}
    ...
    iter = ((Vector)request.getAttribute("MINUTES")).iterator();
%>
                  ...
                  <table width="60%" cellpadding="0" cellspacing="0" align="center" valign="top">
                    <tr>
                      <td colspan="2" align="left">
                       <h2>School Board Meeting Minutes</h2>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td colspan="2">
                        <table width="100%" cellpadding="0" cellspacing="0" align="center" valign="top">
                          <tr>
                            <td width="50%" align="left" class="label">Meeting Date</td>
                            <td width="*" align="center">&nbsp;</td>
                          </tr>
                          <%if(!iter.hasNext()){%>
                              <tr><td colspan="2" class='content' align="left" style="color:#FF0000;font-weight:bold;">No meeting minutes on record.</td></tr>
                          <%}else{
                              int r_cnt = 0;
                              while(iter.hasNext()){
                                dt = (Date)iter.next();%>
                                      ...
                                      <tr>
                                        <td width="100%">
                                          <img src="images/btn_view_01.gif"
                                            ...
                                            onclick="openWindow('VIEW_POLICY', 'http://www.esdnl.ca/board/minutes/archive/esdnl/<%=sdf_file.format(dt)%>.pdf',800, 600, 1);">&nbsp;
                                          <img src="images/btn_delete_01.gif"
                                            onmouseover="src='images/btn_delete_02.gif';"
                                            onmouseout="src='images/btn_delete_01.gif';"
                                            onclick="document.location.href='deleteMinutes.html?dt=<%=sdf.format(dt)%>';">
                                        </td>
                                      </tr>
                                    </table>
                                  </td>
