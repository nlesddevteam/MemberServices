...
<html>
    ...
    <form id="pol_reg_frm" action="addPolicyRegulation.html" method="post" ENCTYPE="multipart/form-data">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" align="center" valign="top">
              <tr>
                <td width="100%" align="left" valign="top">
                  <img src="images/add_policy_regulation_title.gif"><br>
                </td>
              </tr>
              <tr>
                  ...
                  <table width="60%" cellpadding="0" cellspacing="0" align="center" valign="top">
                    <tr>
                      <td colspan="2" align="left">
                        <h2>Add Policy Regulation</h2>
                      </td>
                    </tr>
                    <tr>
                      <td width="125" align="left" valign="middle"><span class="requiredstar">*</span><span class="label">Policy:</span></td>
                      <td width="*" align="left" valign="middle">
                        <select id="policy" name="policy" class="requiredinput">
                          <%while(iter.hasNext()){
                              pol = (Policy) iter.next();%>
                              <option value="<%=pol.getCategoryCode() + "-" + pol.getCode()%>"><%=pol.getCategoryCode() + "-" + pol.getCode()%></option>
                          <%}%>
                        </select>
                      </td>
                    </tr>
                    <tr>
                      <td width="125" align="left" valign="middle"><span class="requiredstar">*</span><span class="label">Regulation Code:</span></td>
                      <td width="*" align="left" valign="middle"><input type="text" class="requiredinput" id="reg_code" name="reg_code" style="width:50px;"></td>
                    </tr>
                    <tr>
                      <td width="125" align="left" valign="middle"><span class="requiredstar">*</span><span class="label">Regulation Title:</span></td>
                      <td width="*" align="left" valign="middle"><input type="text" class="requiredinput" id="reg_title" name="reg_title" style="width:200px;"></td>
                    </tr>
                    <tr>
