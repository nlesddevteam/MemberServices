...
<%
	DiscussionBean discussion = (DiscussionBean) request.getAttribute("DISCUSSIONBEAN");
%>
...
<tr><td>
	...
	<span class="header1">Discussion Summary</span><br />
	
	<p class="header2" width="100%" align="center"><%=discussion.getTitle() %></p>
	<%if(discussion.getGroups().length > 0){ 
		DiscussionGroupBean[] groups = discussion.getGroups();
	%>
		<%for(int g=0; g < groups.length; g++){ 
			GroupCommentBean[] comments = groups[g].getComments();
		%>
			<p>
				<span class="header3"><%=groups[g].getGroupName()%></span><br />
				<ul>
