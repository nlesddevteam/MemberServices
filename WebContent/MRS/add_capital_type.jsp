...
<%}
  ...
  types = (CapitalType[])request.getAttribute("CAPITAL_TYPES");
%>
...
<html>
    ...
    <form id="admin_menu_form" action="addCapitalType.html" method="post">
      <input type="hidden" id="op" name="op" value="ADD">
      <input type="hidden" id="t_id" name="t_id" value="">
      <table width="100%" height="100%" cellpadding="0" cellspacing="0" align="center">
        <tr><td align="center" style="padding-bottom:5px;"><img src="images/admin_utility_menu_add_capital_type_title.gif"><br></td></tr>
        <tr>
          <td id="maincontent">
            <table width="260" cellpadding="1" cellspacing="0" align="center" >
              <%if((types != null)&&(types.length > 0)){
              %><tr><td colspan="2" class="header">Capital Categories</td></tr>
              ...
              %>    <tr>
                      <td width="100%" align="left" colspan="2">
                        <table width="100%" cellpadding="1" cellspacing="0" align="center">
                          <tr>
                            <td width="50%">
                              <span class="label_no_underline"><%=type.getCapitalTypeID()%></span>
                            </td>
                            <td width="*" align="right">
                              <a href="" class="small"
                                onclick="document.forms[0].op.value='DEL'; document.forms[0].t_id.value='<%=type.getCapitalTypeID()%>'; document.forms[0].submit(); return false;">delete</a>
                            </td>
                          </tr>
                        </table>
                      </td>
