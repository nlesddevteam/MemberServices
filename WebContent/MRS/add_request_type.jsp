...
<%}
  ...
  types = (RequestType[])request.getAttribute("REQUEST_TYPES");
%>
...
<html>
    ...
    <form id="admin_menu_form" action="addRequestType.html" method="post">
      <input type="hidden" id="op" name="op" value="ADD">
      <input type="hidden" id="t_id" name="t_id" value="">
      <table width="100%" height="100%" cellpadding="0" cellspacing="0" align="left" >
        <tr><td align="center" style="padding-bottom:5px;"><img src="images/admin_utility_menu_add_request_type_title.gif"><br></td></tr>
        <tr>
          <td id="maincontent">
              ...
              %>    <tr>
                      <td width="100%" align="left" colspan="2">
                        <table width="100%" cellpadding="1" cellspacing="0" align="center" >
                          <tr>
                            <td width="50%">
                              <span class="label_no_underline"><%=type.getRequestTypeID()%></span>
                            </td>
                            <td width="*" align="right">
                              <a href="" class="small" 
                                onclick="document.forms[0].op.value='DEL'; document.forms[0].t_id.value='<%=type.getRequestTypeID()%>'; document.forms[0].submit(); return false;">delete</a>
                            </td>
                          </tr>
                        </table>
                      </td>
