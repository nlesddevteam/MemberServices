...
<%}
  ...
  iter = ((Vector)request.getAttribute("STATUS_CODES")).iterator();
%>
...
<html>
    ...
    <form id="admin_menu_form" action="addStatusCode.html" method="post">
      ...
      <table width="100%" height="100%" cellpadding="0" cellspacing="0" align="left" valign="top">
        <tr><td align="center" style="padding-bottom:5px;"><img src="images/admin_utility_menu_add_status_code_title.gif"><br></td></tr>
        <tr>
          <td id="maincontent">
            <table width="340" cellpadding="1" cellspacing="0" align="center" valign="top">
              ...
              <%    while(iter.hasNext()){
                    type= (StatusCode) iter.next();
              %>    <tr>
                      <td width="100%" align="left" colspan="2">
                        <table width="100%" cellpadding="1" cellspacing="0" align="center" valign="top">
                          <tr>
                            <td width="50%">
                              <span class="label_no_underline"><%=type.getStatusCodeID()%></span>
                            </td>
                            <td width="*" align="right">
                              <a href="" class="small" 
                                onclick="document.forms[0].op.value='DEL'; document.forms[0].t_id.value='<%=type.getStatusCodeID()%>'; document.forms[0].submit(); return false;">delete</a>
                            </td>
                          </tr>
                        </table>
                      </td>
              ...
              <tr>
                <td width="100%" align="left" colspan="2">
                  <table width="100%" cellpadding="1" cellspacing="0" align="center" valign="top">
                    <tr>
                      <td width="50%">
                        <span class="requiredstar">*</span><span class="label">Status Code</span>
                      </td>
                      <td width="*">
                        <input type="text" id="code_id" name="code_id" value="" style="width:230px;" class="requiredinput">
                      </td>
                    </tr>
                  </table>
                </td>
              ...
              <tr>
                ...
                <td width="50%" align="right">
                  <img src="images/btn_cancel_01.gif"
                    ...
                    onclick="document.elements['code_id'].value='';"><br>
                </td>
              </tr>
              <tr><td><img src="images/spacer.gif" height="10" width="1"></td></tr>
