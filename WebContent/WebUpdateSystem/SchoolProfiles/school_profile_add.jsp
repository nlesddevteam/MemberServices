...
<script type="text/javascript" src="../includes/js/jquery.timepicker.js"></script>	
  ...
  <div class="mainContainer">
			...
			<div class="col full_block content">
				...
				<div class="pageTitleHeader siteHeaders">Adding a School to NLESD School Directory</div>
                      <div class="pageBody">
...
<form action='updateSchool.html' method='POST' ENCTYPE="multipart/form-data">
	               ...
	               <input type='hidden' name='provinceState' value='NL' /> 
	               	You are adding a school to the NLESD School directory.              		               	
...
<div class="panel panel-info">
						  	<div class="panel-heading" style="font-weight:bold;">1. SCHOOL NAME/ADDRESS</div>
...
<div class="panel panel-info">
						  	<div class="panel-heading" style="font-weight:bold;">12. OTHER INFORMATION</div>
